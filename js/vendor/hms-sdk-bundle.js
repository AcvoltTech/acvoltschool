(() => {
      ...
      !(function(undefined2) {
        ...
        function searchListenerTree(handlers, type, tree, i2, typeLength) {
          ...
          if (i2 === 0) {
            ...
            if (kind === "string") {
              var ns2, n2, l3 = 0, j2 = 0, delimiter = this.delimiter, dl = delimiter.length;
              if ((n2 = type.indexOf(delimiter)) !== -1) {
                ns2 = new Array(5);
                do {
                  ns2[l3++] = type.slice(j2, n2);
                  j2 = n2 + dl;
                } while ((n2 = type.indexOf(delimiter, j2)) !== -1);
                ns2[l3++] = type.slice(j2);
                type = ns2;
                typeLength = l3;
              } else {
                type = [type];
        ...
        function growListenerTree(type, listener, prepend) {
          var len = 0, j2 = 0, i2, delimiter = this.delimiter, dl = delimiter.length, ns2;
        ...
        EventEmitter.prototype.once = function(event, fn3, options) {
          return this._once(event, fn3, false, options);
        };
        EventEmitter.prototype.prependOnceListener = function(event, fn3, options) {
          return this._once(event, fn3, true, options);
        };
        EventEmitter.prototype._once = function(event, fn3, prepend, options) {
          return this._many(event, 1, fn3, prepend, options);
        };
        EventEmitter.prototype.many = function(event, ttl, fn3, options) {
          return this._many(event, ttl, fn3, false, options);
        };
        EventEmitter.prototype.prependMany = function(event, ttl, fn3, options) {
          return this._many(event, ttl, fn3, true, options);
        };
        EventEmitter.prototype._many = function(event, ttl, fn3, prepend, options) {
          var self2 = this;
        ...
        EventEmitter.prototype.emit = function() {
          ...
          var args, l3, i2, j2, containsSymbol;
        ...
        EventEmitter.prototype.onAny = function(fn3) {
          return this._onAny(fn3, false);
        };
        EventEmitter.prototype.prependAny = function(fn3) {
          return this._onAny(fn3, true);
        };
        EventEmitter.prototype.addListener = EventEmitter.prototype.on;
        EventEmitter.prototype._onAny = function(fn3, prepend) {
          if (typeof fn3 !== "function") {
        ...
        EventEmitter.prototype.offAny = function(fn3) {
          var i2 = 0, l3 = 0, fns;
  ...
  var extend = function(defaultRgx, extensions) {
    ...
    for (var k3 in defaultRgx) {
      mergedRgx[k3] = extraRgx[k3] && extraRgx[k3].length % 2 === 0 ? extraRgx[k3].concat(defaultRgx[k3]) : defaultRgx[k3];
    }
    return mergedRgx;
  };
  ...
  var rgxMapper = function(ua2, arrays) {
    ...
    var i2 = 0, j2, k3, p2, q3, matches, match;
      ...
      while (j2 < regex.length && !matches) {
        ...
        if (!!matches) {
          for (p2 = 0; p2 < props.length; p2++) {
            match = matches[++k3];
            q3 = props[p2];
            if (typeof q3 === TYPEOF.OBJECT && q3.length > 0) {
              if (q3.length === 2) {
                if (typeof q3[1] == TYPEOF.FUNCTION) {
                  this[q3[0]] = q3[1].call(this, match);
                } else {
                  this[q3[0]] = q3[1];
                }
              } else if (q3.length >= 3) {
                if (typeof q3[1] === TYPEOF.FUNCTION && !(q3[1].exec && q3[1].test)) {
                  if (q3.length > 3) {
                    this[q3[0]] = match ? q3[1].apply(this, q3.slice(2)) : void 0;
                  } else {
                    this[q3[0]] = match ? q3[1].call(this, match, q3[2]) : void 0;
                  }
                } else {
                  if (q3.length == 3) {
                    this[q3[0]] = match ? match.replace(q3[1], q3[2]) : void 0;
                  } else if (q3.length == 4) {
                    this[q3[0]] = match ? q3[3].call(this, match.replace(q3[1], q3[2])) : void 0;
                  } else if (q3.length > 4) {
                    this[q3[0]] = match ? q3[3].apply(this, [match.replace(q3[1], q3[2])].concat(q3.slice(4))) : void 0;
                  }
                }
              }
            } else {
              this[q3] = match ? match : void 0;
            }
          }
        }
      }
  ...
  function UAParser(ua2, extensions, headers) {
    ...
    if (headers) {
      if (typeof headers.append === TYPEOF.FUNCTION) {
        var kv = {};
        headers.forEach(function(v2, k3) {
          kv[String(k3).toLowerCase()] = v2;
        });
        headers = kv;
      } else {
        var normalized = {};
  ...
  function shimGetUserMedia(window2, browserDetails) {
    ...
    const constraintsToChrome_ = function(c3) {
      ...
      if (c3.advanced) {
        cc2.optional = (cc2.optional || []).concat(c3.advanced);
      }
      return cc2;
    };
  ...
  var Ao = Reflect.get;
  var ys = (a10, e, t2) => e in a10 ? Eo(a10, e, { enumerable: true, configurable: true, writable: true, value: t2 }) : a10[e] = t2;
  var m = (a10, e) => {
    for (var t2 in e || (e = {})) ks.call(e, t2) && ys(a10, t2, e[t2]);
    if (di) for (var t2 of di(e)) Es.call(e, t2) && ys(a10, t2, e[t2]);
    return a10;
  };
  var M2 = (a10, e) => Po(a10, bo(e));
  var Ar = (a10, e) => {
    var t2 = {};
    for (var i2 in a10) ks.call(a10, i2) && e.indexOf(i2) < 0 && (t2[i2] = a10[i2]);
    if (a10 != null && di) for (var i2 of di(a10)) e.indexOf(i2) < 0 && Es.call(a10, i2) && (t2[i2] = a10[i2]);
    return t2;
  };
  var Ro = (a10, e) => () => (e || a10((e = { exports: {} }).exports, e), e.exports);
  var ue = (a10, e, t2) => Ao(Io(a10), t2, e);
  ...
  var ui = () => ({ peerStats: {}, remoteTrackStats: {}, localTrackStats: {}, localPeer: { id: "" } });
  var Ho = ((e) => (e.CHAT = "chat", e))(Ho || {});
  var Ps = ((t2) => (t2.INFO = "info", t2.ERROR = "error", t2))(Ps || {});
  var Hr = ((w2) => (w2.PEER_JOINED = "PEER_JOINED", w2.PEER_LEFT = "PEER_LEFT", w2.PEER_LIST = "PEER_LIST", w2.NEW_MESSAGE = "NEW_MESSAGE", w2.ERROR = "ERROR", w2.RECONNECTING = "RECONNECTING", w2.RECONNECTED = "RECONNECTED", w2.TRACK_ADDED = "TRACK_ADDED", w2.TRACK_REMOVED = "TRACK_REMOVED", w2.TRACK_MUTED = "TRACK_MUTED", w2.TRACK_UNMUTED = "TRACK_UNMUTED", w2.TRACK_DEGRADED = "TRACK_DEGRADED", w2.TRACK_RESTORED = "TRACK_RESTORED", w2.TRACK_DESCRIPTION_CHANGED = "TRACK_DESCRIPTION_CHANGED", w2.ROLE_UPDATED = "ROLE_UPDATED", w2.CHANGE_TRACK_STATE_REQUEST = "CHANGE_TRACK_STATE_REQUEST", w2.CHANGE_MULTI_TRACK_STATE_REQUEST = "CHANGE_MULTI_TRACK_STATE_REQUEST", w2.ROOM_ENDED = "ROOM_ENDED", w2.REMOVED_FROM_ROOM = "REMOVED_FROM_ROOM", w2.DEVICE_CHANGE_UPDATE = "DEVICE_CHANGE_UPDATE", w2.PLAYLIST_TRACK_ENDED = "PLAYLIST_TRACK_ENDED", w2.NAME_UPDATED = "NAME_UPDATED", w2.METADATA_UPDATED = "METADATA_UPDATED", w2.POLL_CREATED = "POLL_CREATED", w2.POLL_STARTED = "POLL_STARTED", w2.POLL_STOPPED = "POLL_STOPPED", w2.POLL_VOTES_UPDATED = "POLL_VOTES_UPDATED", w2.POLLS_LIST = "POLLS_LIST", w2.HAND_RAISE_CHANGED = "HAND_RAISE_CHANGED", w2.TRANSCRIPTION_STATE_UPDATED = "TRANSCRIPTION_STATE_UPDATED", w2))(Hr || {});
  var bs = ((t2) => (t2.audio = "audio", t2.video = "video", t2))(bs || {});
  function We(a10, e) {
    let t2, i2;
    if (e) for (let r2 of e.auxiliaryTracks) {
      let s2 = a10[r2];
      Co(s2) && (i2 = vt(s2) ? s2 : i2, t2 = Mt(s2) ? s2 : t2);
    }
  ...
  var Rs = ((d2) => (d2[d2.VERBOSE = 0] = "VERBOSE", d2[d2.DEBUG = 1] = "DEBUG", d2[d2.INFO = 2] = "INFO", d2[d2.WARN = 3] = "WARN", d2[d2.TIME = 4] = "TIME", d2[d2.TIMEEND = 5] = "TIMEEND", d2[d2.ERROR = 6] = "ERROR", d2[d2.NONE = 7] = "NONE", d2))(Rs || {});
  ...
  var Et = null;
  var Lr = null;
  var B2 = typeof window != "undefined";
  if (B2) try {
    let a10 = Cr.getResult(), e = a10.withClientHints();
    e && typeof e.then == "function" ? (Lr = e, Lr.then((t2) => {
      Et = t2;
    }).catch(() => {
      Et = a10;
    })) : (l2.d("UAParser", "Client Hints not supported, using standard UA parsing"), Et = e);
  } catch (a10) {
    Et = Cr.getResult();
  }
  ...
  var wo = () => !$e;
  var Bc = wo();
  var Pt = () => Se.getDevice().type === "mobile";
  var Os = () => typeof document != "undefined" && document.hidden;
  var xs = () => {
    var a10;
    return ((a10 = Se.getOS().name) == null ? void 0 : a10.toLowerCase()) === "ios";
  };
  var Cs;
  var Ls;
  ...
  var Ds;
  var ws;
  var Bs = ((ws = (Ds = Se.getBrowser()) == null ? void 0 : Ds.name) == null ? void 0 : ws.toLowerCase()) === "firefox";
  var _s;
  var Ns;
  var Vs = ((Ns = (_s = Se.getEngine()) == null ? void 0 : _s.name) == null ? void 0 : Ns.toLowerCase()) === "blink";
  var Fs = ((i2) => (i2.CUSTOM = "CUSTOM", i2.LOCAL = "LOCAL", i2.HMS = "HMS", i2))(Fs || {});
  function _o() {
    if (B2 && window) {
  ...
  var Gs = ((r2) => (r2.AUDIO = "audio", r2.VIDEO = "video", r2.AUDIO_VIDEO = "audio, video", r2.SCREEN = "screen", r2))(Gs || {});
  function Dr(a10) {
    switch (a10) {
      case "join":
        return "JOIN";
  ...
  var S2 = { WebSocketConnectionErrors: { FailedToConnect(a10, e = "") {
    ...
    return new q2(k2.TracksErrors.GENERIC_TRACK, "GenericTrack", a10, `[TRACK]: ${e}`, `[TRACK]: ${e}`, "audio, video");
  }, CantAccessCaptureDevice(a10, e, t2 = "") {
    return new q2(k2.TracksErrors.CANT_ACCESS_CAPTURE_DEVICE, "CantAccessCaptureDevice", a10, `User denied permission to access capture device - ${e}`, t2, e);
  }, DeviceNotAvailable(a10, e, t2 = "") {
    return new q2(k2.TracksErrors.DEVICE_NOT_AVAILABLE, "DeviceNotAvailable", a10, `[TRACK]: Capture device is no longer available - ${e}`, t2, e);
  }, DeviceInUse(a10, e, t2 = "") {
    return new q2(k2.TracksErrors.DEVICE_IN_USE, "DeviceInUse", a10, `[TRACK]: Capture device is in use by another application - ${e}`, t2, e);
  }, DeviceLostMidway(a10, e, t2 = "") {
    return new q2(k2.TracksErrors.DEVICE_LOST_MIDWAY, "DeviceLostMidway", a10, `Lost access to capture device midway - ${e}`, t2, e);
  }, NothingToReturn(a10, e = "", t2 = "There is no media to return. Please select either video or audio or both.") {
    return new q2(k2.TracksErrors.NOTHING_TO_RETURN, "NothingToReturn", a10, t2, e, "audio, video");
  }, InvalidVideoSettings(a10, e = "") {
    return new q2(k2.TracksErrors.INVALID_VIDEO_SETTINGS, "InvalidVideoSettings", a10, "Cannot enable simulcast when no video settings are provided", e, "video");
  }, AutoplayBlocked(a10, e = "") {
    return new q2(k2.TracksErrors.AUTOPLAY_ERROR, "AutoplayBlocked", a10, "Autoplay blocked because the user didn't interact with the document first", e, "audio");
  }, CodecChangeNotPermitted(a10, e = "") {
    return new q2(k2.TracksErrors.CODEC_CHANGE_NOT_PERMITTED, "CodecChangeNotPermitted", a10, "Codec can't be changed mid call.", e, "audio, video");
  }, OverConstrained(a10, e, t2 = "") {
    return new q2(k2.TracksErrors.OVER_CONSTRAINED, "OverConstrained", a10, `[TRACK]: Requested constraints cannot be satisfied with the device hardware - ${e}`, t2, e);
  }, NoAudioDetected(a10, e = "Please check the mic or use another audio input") {
    return new q2(k2.TracksErrors.NO_AUDIO_DETECTED, "NoAudioDetected", a10, "No audio input detected from microphone", e, "audio");
  }, SystemDeniedPermission(a10, e, t2 = "") {
    return new q2(k2.TracksErrors.SYSTEM_DENIED_PERMISSION, "SystemDeniedPermission", a10, `Operating System denied permission to access capture device - ${e}`, t2, e);
  }, CurrentTabNotShared() {
    return new q2(k2.TracksErrors.CURRENT_TAB_NOT_SHARED, "CurrentTabNotShared", "TRACK", "The app requires you to share the current tab", "You must screen share the current tab in order to proceed", "screen");
  }, AudioPlaybackError(a10) {
    return new q2(k2.TracksErrors.AUDIO_PLAYBACK_ERROR, "Audio playback error", "TRACK", a10, a10, "audio");
  }, SelectedDeviceMissing(a10) {
    return new q2(k2.TracksErrors.SELECTED_DEVICE_MISSING, "SelectedDeviceMissing", "TRACK", `Could not detect selected ${a10} device`, `Please check connection to the ${a10} device`, a10);
  }, NoDataInTrack(a10) {
    return new q2(k2.TracksErrors.NO_DATA, "Track does not have any data", "TRACK", a10, "This could possibily due to another application taking priority over the access to camera or microphone or due to an incoming call", "audio, video");
    ...
    return new E2(a10, "ServerErrors", e, t2, t2, No.includes(e));
  }, AlreadyJoined(a10, e = "") {
  ...
  var Ws = () => {
    try {
      B2 && !localStorage && (window.localStorage = new wr());
    } catch (a10) {
  ...
  var ve = class {
    ...
    getStorage() {
      try {
        return B2 && !this.storage && (Ws(), this.storage = window.localStorage), this.storage;
      } catch (e) {
  ...
  var qs = _r().version;
  function At(a10 = "prod", e) {
    let t2 = "web", i2 = et !== "LOCAL" && a10 === "prod" ? "prod" : "debug";
    if ($e) return js({ os: "web_nodejs", os_version: process.version, sdk: t2, sdk_version: qs, env: i2, domain: et, is_prebuilt: !!(e != null && e.isPrebuilt), framework: "node", framework_version: process.version, framework_sdk_version: e == null ? void 0 : e.sdkVersion });
    let r2 = Se.getOS(), s2 = Se.getDevice(), o2 = Se.getBrowser(), n2 = Nr(`web_${r2.name}`), d2 = r2.version || "", u2 = Nr(`${o2.name}_${o2.version}`), p2 = u2;
    return s2.type && (p2 = `${Nr(`${s2.vendor}_${s2.type}`)}/${u2}`), js({ os: n2, os_version: d2, sdk: t2, sdk_version: qs, device_model: p2, env: i2, domain: et, is_prebuilt: !!(e != null && e.isPrebuilt), framework: e == null ? void 0 : e.type, framework_version: e == null ? void 0 : e.version, framework_sdk_version: e == null ? void 0 : e.sdkVersion });
  }
  function Nr(a10) {
    return a10.replace(/ /g, "_");
  }
  var js = (a10, e = ",") => Object.keys(a10).filter((t2) => $(a10[t2])).map((t2) => `${t2}:${a10[t2]}`).join(e);
  var C = class {
    constructor({ name: e, level: t2, properties: i2, includesPII: r2, timestamp: s2 }) {
      this.metadata = { peer: {}, userAgent: At() };
      this.name = e, this.level = t2, this.includesPII = r2 || false, this.properties = i2 || {}, this.timestamp = s2 || (/* @__PURE__ */ new Date()).getTime(), this.event_id = v4_default(), this.device_id = hi();
    }
    toSignalParams() {
      return { name: this.name, info: M2(m({}, this.properties), { timestamp: this.timestamp, domain: et }), timestamp: (/* @__PURE__ */ new Date()).getTime() };
    }
  };
  var y2 = class {
    ...
    static preview(i2) {
      var r2 = i2, { error: e } = r2, t2 = Ar(r2, ["error"]);
    ...
    static interruption({ started: e, type: t2, reason: i2, deviceInfo: r2, trackInfo: s2 }) {
      return new C({ name: `${e ? "interruption.start" : "interruption.stop"}`, level: 1, properties: M2(m({ reason: i2, type: t2, pageHidden: document.visibilityState === "hidden" }, r2), { trackInfo: s2 }) });
    }
    static mediaConstraints({ requestedConstraints: e, appliedConstraints: t2, trackSettings: i2 }) {
      return new C({ name: "media.constraints", level: 1, properties: { requested_constraints: e, applied_constraints: t2, track_settings: i2, webgpu_supported: typeof navigator != "undefined" && "gpu" in navigator, media_stream_track_processor_supported: typeof window != "undefined" && "MediaStreamTrackProcessor" in window } });
    }
  ...
  var _e = class {
    ...
    sendInterruptionEvent({ started: e, reason: t2 }) {
      ...
      return y2.interruption({ started: e, type: this.type, reason: t2, deviceInfo: { deviceId: i2.getSettings().deviceId, groupId: i2.getSettings().groupId }, trackInfo: { label: i2.label, enabled: i2.enabled, muted: i2.muted, readyState: i2.readyState, settings: i2.getSettings() } });
    }
    cleanup() {
      var e;
  ...
  var Ne = class extends _e {
    ...
    setOutputDevice(t2) {
      return c2(this, null, function* () {
        ...
        try {
          typeof this.audioElement.setSinkId == "function" && Vs && (yield (i2 = this.audioElement) == null ? void 0 : i2.setSinkId(t2.deviceId), this.outputDevice = t2);
        } catch (r2) {
  ...
  var Or = class {
    ...
    setDevices(e) {
      ...
      let t2 = this.storage.get();
      if (!t2) return;
      let i2 = ["audioInput", "videoInput", "audioOutput"];
      for (let s2 of i2) {
        let o2 = t2[s2];
        o2 && ((r2 = e[s2]) != null && r2.some((d2) => this.isSame(o2, d2)) || (l2.w(this.TAG, `Removing ${s2} device from storage as it's no longer available: ${o2.deviceId}`), this.removeSelection(s2)));
      }
    }
    rememberDevices(e) {
      this.remember = e;
    ...
    removeSelection(e) {
      let t2 = this.storage.get() || {};
      t2[e] && (delete t2[e], this.storage.set(t2));
    }
    getSelection() {
  ...
  var te = new Or();
  var xr = ((t2) => (t2.TRANSFORM = "TRANSFORM", t2.ANALYZE = "ANALYZE", t2))(xr || {});
  var Ur = ((t2) => (t2.PLATFORM_NOT_SUPPORTED = "PLATFORM_NOT_SUPPORTED", t2.DEVICE_NOT_SUPPORTED = "DEVICE_NOT_SUPPORTED", t2))(Ur || {});
  var ge = class {
    static failure(e, t2) {
  ...
  var Si = class {
    ...
    added(e, t2) {
      this.pluginAdded[e] = true, this.addedTimestamps[e] = Date.now(), this.initTime[e] = 0, this.pluginSampleRate[e] = t2, this.eventBus.analytics.publish(ge.added(e, this.addedTimestamps[e]));
    }
    removed(e) {
      if (this.pluginAdded[e]) {
        ...
        this.eventBus.analytics.publish(ge.audioPluginStats(t2)), this.clean(e);
      }
    }
    failure(e, t2) {
      this.pluginAdded[e] && (this.eventBus.analytics.publish(ge.audioPluginFailure(e, this.pluginSampleRate[e], t2)), this.clean(e));
    }
    initWithTime(e, t2) {
      return c2(this, null, function* () {
        if (this.initTime[e]) {
  ...
  var Rt = class {
    constructor(e, t2, i2) {
      ...
      this.hmsTrack = e, this.pluginsMap = /* @__PURE__ */ new Map(), this.analytics = new Si(t2), this.audioContext = pe.getAudioContext(), this.room = i2;
    }
    getPlugins() {
  ...
  var Js = ((n2) => (n2.NONE = "none", n2.INITIALISED = "initialised", n2.STARTED = "started", n2.PAUSED = "paused", n2.RESUMED = "resumed", n2.STOPPED = "stopped", n2.FAILED = "failed", n2))(Js || {});
  var zs = ((t2) => (t2.DVR = "dvr", t2.NO_DVR = "no-dvr", t2))(zs || {});
  var Ys = ((i2) => (i2.REGULAR = "regular", i2.SCREEN = "screen", i2.COMPOSITE = "composite", i2))(Ys || {});
  var Xs = ((r2) => (r2.INITIALISED = "initialised", r2.STARTED = "started", r2.STOPPED = "stopped", r2.FAILED = "failed", r2))(Xs || {});
  var Zs = ((e) => (e.CAPTION = "caption", e))(Zs || {});
  var Ke = { f: "high", h: "medium", q: "low" };
  var Vr = ((t2) => (t2.VOICE = "voice", t2.MUSIC = "music", t2))(Vr || {});
  var ea = ((i2) => (i2.videoInput = "videoInput", i2.audioInput = "audioInput", i2.audioOutput = "audioOutput", i2))(ea || {});
  var Y2 = class {
    constructor() {
      this._volume = 1;
      this._codec = "opus";
    ...
    build() {
      return new qe(this._volume, this._codec, this._maxBitrate, this._deviceId, this._advanced, this._audioMode);
    }
  };
  var qe = class {
  ...
  var J = class {
    ...
    build() {
      return new je(this._width, this._height, this._codec, this._maxFramerate, this._deviceId, this._advanced, this._maxBitrate, this._facingMode);
    }
  };
  var je = class {
    ...
    improviseConstraintsAspect() {
      return Pt() && this.height && this.width && this.height > this.width ? { width: this.height, height: this.width } : { width: this.width, height: this.height };
    }
  };
  var xe = class {
    constructor() {
      this._video = new J().build();
      this._audio = new Y2().build();
      this._screen = new J().build();
    ...
    build() {
      ...
      return new tt(this._video, this._audio, this._simulcast, this._screen || void 0);
    }
  };
  var tt = class {
  ...
  var pe = { audioContext: null, getAudioContext() {
    return this.audioContext || (this.audioContext = Bs ? new AudioContext() : new AudioContext({ sampleRate: Go })), this.audioContext;
  }, resumeContext() {
    return c2(this, null, function* () {
      try {
  ...
  var Fr = ((r2) => (r2.SPEAKERPHONE = "SPEAKERPHONE", r2.WIRED = "WIRED", r2.BLUETOOTH = "BLUETOOTH", r2.EARPIECE = "EARPIECE", r2))(Fr || {});
  var Gr = (a10) => {
  ...
  var Wr = { isAudioMuted: false, isVideoMuted: false, audioInputDeviceId: "default", audioOutputDeviceId: "default", videoDeviceId: "default", audioMode: "voice" };
  var Me;
  var Ti;
  var Te = class a3 {
    ...
    getTracksToPublish() {
      return c2(this, arguments, function* (e = Wr) {
    ...
    getNativeLocalTracks() {
      return c2(this, arguments, function* (e = { audio: false, video: false }, t2) {
        let i2 = new tt(e.video === true ? t2.video : null, e.audio === true ? t2.audio : null, t2.simulcast), r2 = [];
    ...
    getLocalScreen(e, t2 = false) {
      return c2(this, null, function* () {
        ...
        try {
          ...
          let f2 = Oe(g2, "screen");
          throw this.eventBus.analytics.publish(y2.publish({ error: f2, devices: this.deviceManager.getDevices(), settings: new tt(r2 == null ? void 0 : r2.video, r2 == null ? void 0 : r2.audio, false) })), f2;
        }
        let n2 = [], d2 = new fe(o2), u2 = o2.getVideoTracks()[0], p2 = new K(d2, u2, "screen", this.eventBus, r2 == null ? void 0 : r2.video, this.store.getRoom());
        ...
        if (h2) {
          let g2 = new he(d2, h2, "screen", this.eventBus, r2 == null ? void 0 : r2.audio, this.store.getRoom());
          n2.push(g2);
        }
    ...
    static getEmptyVideoTrack(e) {
      ...
      Me || (Me = document.createElement("canvas"), Me.width = t2, Me.height = i2, (u2 = Me.getContext("2d")) == null || u2.fillRect(0, 0, t2, i2)), Ti || (Ti = setInterval(() => {
    ...
    static getEmptyAudioTrack() {
      let e = pe.getAudioContext(), t2 = e.createOscillator(), i2 = e.createMediaStreamDestination();
      t2.connect(i2), t2.start();
      let r2 = i2.stream.getAudioTracks()[0];
      return r2.enabled = false, r2;
    }
    static cleanup() {
      clearInterval(Ti), Ti = void 0, Me = void 0;
    }
    getAVTracks(e) {
      return c2(this, null, function* () {
        var i2, r2, s2, o2;
        let t2 = { audio: e.audio ? e.audio.toConstraints() : false, video: e.video ? e.video.toConstraints() : false };
        try {
          let n2 = yield navigator.mediaDevices.getUserMedia(t2), d2 = n2.getVideoTracks(), u2 = n2.getAudioTracks();
          return this.eventBus.analytics.publish(y2.mediaConstraints({ requestedConstraints: t2, appliedConstraints: { video: (i2 = d2[0]) == null ? void 0 : i2.getConstraints(), audio: (r2 = u2[0]) == null ? void 0 : r2.getConstraints() }, trackSettings: { video: (s2 = d2[0]) == null ? void 0 : s2.getSettings(), audio: (o2 = u2[0]) == null ? void 0 : o2.getSettings() } })), d2.concat(u2);
        } catch (n2) {
          yield this.deviceManager.init();
          let d2 = !!(!this.deviceManager.hasWebcamPermission && e.video), u2 = !!(!this.deviceManager.hasMicrophonePermission && e.audio), p2 = this.getErrorType(d2, u2);
          throw Oe(n2, p2);
        }
      });
    }
    getAVTrackSettings(e) {
      ...
      return !t2 && !i2 ? null : new xe().video(i2).audio(t2).build();
    }
    isInIframe() {
      try {
    ...
    retryGetLocalTracks(e, t2, i2, r2) {
      return c2(this, null, function* () {
        if (e instanceof E2 && e.action === "TRACK") {
          ...
          if (s2) {
            let d2 = new xe().video(new je()).audio(new qe()).build();
    ...
    getAudioSettings(e) {
      ...
      return new Y2().codec(t2.audio.codec).maxBitrate(t2.audio.bitRate).deviceId(s2 || Wr.audioInputDeviceId).build();
    }
    getVideoSettings(e) {
      var n2;
      let t2 = this.store.getPublishParams();
      ...
      return new J().codec(o2.codec).maxBitrate(o2.bitRate).maxFramerate(o2.frameRate).setWidth(o2.width).setHeight(o2.height).deviceId(s2 || Wr.videoDeviceId).build();
    }
    getScreenshareSettings(e = false) {
      ...
      let i2 = t2.screen;
      return { video: new J().maxBitrate(i2.bitRate, false).codec(i2.codec).maxFramerate(i2.frameRate).setWidth(i2.width).setHeight(i2.height).build(), audio: e ? void 0 : new Y2().build() };
    }
    ...
    createHMSLocalTracks(e, t2, i2) {
      ...
      i2 ? e.forEach((n2) => i2 == null ? void 0 : i2.nativeStream.addTrack(n2)) : i2 = new fe(new MediaStream(e));
      let o2 = [];
      if (s2 && (t2 != null && t2.audio)) {
        let n2 = new he(i2, s2, "regular", this.eventBus, t2.audio, this.store.getRoom());
        o2.push(n2);
      }
      if (r2 && (t2 != null && t2.video)) {
        let n2 = new K(i2, r2, "regular", this.eventBus, t2.video, this.store.getRoom());
  ...
  function Be(a10) {
    if (a10 < 0) throw Error("`ms` should be a positive integer");
    if (typeof Worker == "undefined") return X2(a10);
    let e = new Worker(URL.createObjectURL(new Blob([ia], { type: "application/javascript" })));
  ...
  function ra() {
    if (typeof Worker == "undefined") return { sleep: (e) => X2(e) };
    let a10 = new Worker(URL.createObjectURL(new Blob([ia], { type: "application/javascript" })));
  ...
  var Mi = class {
    constructor(e, t2, i2) {
      ...
      this.history = new Ue(this.historyInterval / this.interval);
    ...
    loop() {
      return c2(this, null, function* () {
        for (; this.isMonitored; ) this.sendAudioLevel(this.getMaxAudioLevelOverPeriod()), yield X2(this.interval);
      });
    }
    sendAudioLevel(e = 0) {
      if (e = e > $o ? e : 0, Math.abs(this.audioLevel - e) > Ko) {
        this.audioLevel = e;
    ...
    createAnalyserNodeForStream(e) {
      let t2 = pe.getAudioContext(), i2 = t2.createMediaStreamSource(e), r2 = t2.createAnalyser();
  ...
  var he = class a4 extends Ne {
    constructor(t2, i2, r2, s2, o2 = new Y2().build(), n2) {
      ...
      this.handleTrackMute = () => {
        l2.d(this.TAG, "muted natively"), this.eventBus.analytics.publish(this.sendInterruptionEvent({ started: true, reason: "track-muted-natively" })), this.eventBus.localAudioEnabled.publish({ enabled: false, track: this });
      };
      this.handleTrackUnmute = () => c2(this, null, function* () {
        l2.d(this.TAG, "unmuted natively"), this.eventBus.analytics.publish(this.sendInterruptionEvent({ started: false, reason: "track-unmuted-natively" }));
        try {
      ...
      this.handleSettingsChange = (t3) => c2(this, null, function* () {
        let i3 = this.stream, r3 = sa(t3, this.settings);
      ...
      this.handleDeviceChange = (t3, i3 = false) => c2(this, null, function* () {
        if (sa(t3, this.settings)("deviceId")) {
          ...
          !i3 && t3.deviceId && (te.updateSelection("audioInput", { deviceId: t3.deviceId, groupId: s3 }), this.eventBus.deviceChange.publish({ isUserSelection: true, type: "audioInput", selection: { deviceId: t3.deviceId, groupId: s3, label: this.nativeTrack.label } }));
        }
      });
      t2.tracks.push(this), this.addTrackEventListeners(i2), this.trackPermissions(), this.settings = o2, o2.deviceId !== i2.getSettings().deviceId && !ye(i2) && (this.settings = this.buildNewSettings({ deviceId: i2.getSettings().deviceId })), this.pluginsManager = new Rt(this, s2, n2), this.setFirstTrackId(i2.id), r2 === "regular" && document.addEventListener("visibilitychange", this.handleVisibilityChange);
    }
    clone(t2) {
    ...
    replaceTrackWith(t2) {
      return c2(this, null, function* () {
        ...
        try {
          let r2 = yield Kr(t2);
          this.addTrackEventListeners(r2), this.tracksCreated.add(r2), this.eventBus.analytics.publish(y2.mediaConstraints({ requestedConstraints: { audio: t2.toConstraints() }, appliedConstraints: { audio: r2.getConstraints() }, trackSettings: { audio: r2.getSettings() } })), l2.d(this.TAG, "replaceTrack, Previous track stopped", i2, "newTrack", r2), yield this.updateTrack(r2);
        } catch (r2) {
          let s2 = r2;
          if (s2.code === k2.TracksErrors.CANT_ACCESS_CAPTURE_DEVICE || s2.code === k2.TracksErrors.SYSTEM_DENIED_PERMISSION) {
            let n2 = yield Te.getEmptyAudioTrack();
            throw this.addTrackEventListeners(n2), this.tracksCreated.add(n2), yield this.updateTrack(n2), s2;
          }
          let o2 = yield Kr(this.settings);
          throw this.addTrackEventListeners(o2), this.tracksCreated.add(o2), this.eventBus.analytics.publish(y2.mediaConstraints({ requestedConstraints: { audio: this.settings.toConstraints() }, appliedConstraints: { audio: o2.getConstraints() }, trackSettings: { audio: o2.getSettings() } })), yield this.updateTrack(o2), this.isPublished && this.eventBus.analytics.publish(y2.publish({ error: r2 })), r2;
        }
        try {
    ...
    setEnabled(t2, i2 = false) {
      return c2(this, null, function* () {
        t2 === this.enabled && !i2 || (t2 && this.shouldReacquireTrack() && (yield this.replaceTrackWith(this.settings)), yield ue(a4.prototype, this, "setEnabled").call(this, t2), t2 && (this.settings = this.buildNewSettings({ deviceId: this.nativeTrack.getSettings().deviceId })), this.eventBus.localAudioEnabled.publish({ enabled: t2, track: this }));
      });
    }
    ...
    initAudioLevelMonitor() {
      this.audioLevelMonitor && this.destroyAudioLevelMonitor(), l2.d(this.TAG, "Monitor Audio Level for", this, this.getMediaTrackSettings().deviceId), this.audioLevelMonitor = new Mi(this, this.eventBus.trackAudioLevelUpdate, this.eventBus.localAudioSilence), this.audioLevelMonitor.start(), this.audioLevelMonitor.detectSilence();
    }
    ...
    buildNewSettings(t2) {
      ...
      return new qe(i2, r2, s2, o2, n2, d2);
    }
  };
  var oe = class a5 extends Ne {
    setEnabled(e) {
      return c2(this, null, function* () {
        e !== this.enabled && (yield ue(a5.prototype, this, "setEnabled").call(this, e), yield this.subscribeToAudio(e));
      });
    }
  };
  var it = class extends _e {
    constructor(t2, i2, r2) {
      super(t2, i2, r2);
      this.type = "video";
      this.sinkCount = 0;
    ...
    addPropertiesToElement(t2) {
      Us || (t2.autoplay = true), t2.playsInline = true, t2.muted = true, t2.controls = false;
    }
  };
  var Ht = { none: -1, low: 0, medium: 1, high: 2 };
  var jo = 0.5;
  var aa = (a10, e) => {
    let t2 = "high", i2 = e.width > e.height ? "width" : "height", r2 = [...a10].sort((o2, n2) => Ht[o2.layer] - Ht[n2.layer]), s2 = e[i2] * ((window == null ? void 0 : window.devicePixelRatio) || 1);
  ...
  var jr = class {
    ...
    isSupported() {
      let e = B2 && typeof window.IntersectionObserver != "undefined";
  ...
  var Qr = class {
    constructor() {
      ...
      this.createObserver = () => {
        this.isSupported() && !this.resizeObserver && (this.resizeObserver = new ResizeObserver(vi(this.handleResize, 300)));
      };
      this.handleResize = (e) => {
        var t2;
        for (let i2 of e) (t2 = this.listeners.get(i2.target)) == null || t2(i2);
    ...
    isSupported() {
      let e = B2 && typeof window.ResizeObserver != "undefined";
  ...
  var rt = class {
    constructor(e) {
      ...
      this.handleResize = (e2) => c2(this, null, function* () {
        !this.track.enabled || !(this.track instanceof x2) || (this.entries.set(e2.target, e2.contentRect), yield this.selectMaxLayer());
      });
      this.cleanup = () => {
    ...
    init() {
      B2 && (this.resizeObserver = na, this.intersectionObserver = oa);
    }
    ...
    selectMaxLayer() {
      return c2(this, null, function* () {
        if (!(this.track instanceof x2) || this.videoElements.size === 0) return;
        let e;
        for (let t2 of this.videoElements) {
          ...
          let o2 = aa(this.track.getSimulcastDefinitions(), { width: r2, height: s2 });
          e ? e = Ht[o2] > Ht[e] ? o2 : e : e = o2;
        }
        e && (l2.d(this.TAG, `selecting max layer ${e} for the track`, `${this.track}`), yield this.track.setPreferredLayer(e));
      });
    }
  };
  var Jr = ((t2) => (t2.TRANSFORM = "TRANSFORM", t2.ANALYZE = "ANALYZE", t2))(Jr || {});
  var zr = ((t2) => (t2["2D"] = "2d", t2.WEBGL = "webgl", t2.WEBGL2 = "webgl2", t2))(zr || {});
  var Ct = class {
    constructor() {
      this.total = 0;
      this.count = 0;
  ...
  var st = class {
    constructor(e) {
      ...
      this.initTime = {}, this.preProcessingAvgs = new Ct(), this.addedTimestamps = {}, this.processingAvgs = {}, this.pluginAdded = {}, this.pluginInputFrameRate = {}, this.pluginFrameRate = {};
    }
    added(e, t2, i2) {
      this.pluginAdded[e] = true, this.addedTimestamps[e] = Date.now(), this.initTime[e] = 0, this.processingAvgs[e] = new Ct(), t2 && (this.pluginInputFrameRate[e] = t2, this.pluginFrameRate[e] = i2 || t2), this.eventBus.analytics.publish(ge.added(e, this.addedTimestamps[e]));
    }
    removed(e) {
      var t2;
      if (this.pluginAdded[e]) {
        ...
        this.eventBus.analytics.publish(ge.stats(i2)), this.clean(e);
      }
    }
    failure(e, t2) {
      this.pluginAdded[e] && (this.eventBus.analytics.publish(ge.failure(e, t2)), this.clean(e));
    }
    initWithTime(e, t2) {
      return c2(this, null, function* () {
        if (this.initTime[e]) {
  ...
  var Lt = class {
    constructor(e, t2) {
      ...
      this.pluginAddInProgress = false;
      this.reusableWorker = ra();
      this.hmsTrack = e, this.pluginsMap = /* @__PURE__ */ new Map(), this.pluginNumFramesToSkip = {}, this.pluginNumFramesSkipped = {}, this.analytics = new st(t2), this.canvases = new Array();
    }
    getPlugins() {
      return Array.from(this.pluginsMap.keys());
    }
    ...
    addPluginInternal(e, t2) {
      return c2(this, null, function* () {
        ...
        let r2 = this.hmsTrack.getMediaTrackSettings().frameRate || ca, s2 = 0;
    ...
    waitForRestart() {
      return c2(this, null, function* () {
        if (!(!this.pluginsLoopRunning || this.pluginsLoopState === "running")) for (; this.pluginsLoopState === "paused"; ) yield Be(100);
      });
    }
    cleanup() {
      return c2(this, null, function* () {
    ...
    pluginsLoop() {
      return c2(this, null, function* () {
        for (; this.pluginsLoopRunning; ) {
          let e = this.hmsTrack.getMediaTrackSettings().frameRate || ca, t2 = Math.floor(1e3 / e);
    ...
    updateInputCanvas() {
      return c2(this, null, function* () {
        ...
        let { width: e = Jo, height: t2 = zo } = this.hmsTrack.getMediaTrackSettings();
  ...
  var yi = class {
    constructor(e, t2) {
      ...
      this.plugins = /* @__PURE__ */ new Set(), this.analytics = new st(e), this.room = t2;
    }
    addPlugins(e) {
      e.forEach((t2) => {
        var i2;
  ...
  var K = class a6 extends it {
    constructor(t2, i2, r2, s2, o2 = new J().build(), n2) {
      ...
      this.buildNewSettings = (t3) => {
        ...
        return new je(i3, r3, s3, o3, d2, u2, n3, p2);
      };
      this.handleSettingsChange = (t3) => c2(this, null, function* () {
        let i3 = this.stream, r3 = da(t3, this.settings);
      ...
      this.handleDeviceChange = (t3, i3 = false) => c2(this, null, function* () {
        if (da(t3, this.settings)("deviceId") && this.source === "regular") {
          if (this.enabled) {
          ...
          let s3 = this.nativeTrack.getSettings().groupId;
          !i3 && t3.deviceId && (te.updateSelection("videoInput", { deviceId: t3.deviceId, groupId: s3 }), this.eventBus.deviceChange.publish({ isUserSelection: true, type: "video", selection: { deviceId: t3.deviceId, groupId: s3, label: this.nativeTrack.label } }));
        }
      });
      this.trackPermissions = () => {
        fi("camera", (t3) => {
      ...
      this.handleTrackMute = () => {
        l2.d(this.TAG, "muted natively", document.visibilityState), this.eventBus.analytics.publish(this.sendInterruptionEvent({ started: true, reason: "track-muted-natively" })), this.eventBus.localVideoEnabled.publish({ enabled: false, track: this });
      };
      this.handleTrackUnmuteNatively = () => c2(this, null, function* () {
        l2.d(this.TAG, "unmuted natively"), this.eventBus.analytics.publish(this.sendInterruptionEvent({ started: false, reason: "track-unmuted-natively" })), this.handleTrackUnmute(), this.eventBus.localVideoEnabled.publish({ enabled: this.enabled, track: this }), this.eventBus.localVideoUnmutedNatively.publish(), yield this.setEnabled(this.enabled);
      });
      ...
      this.addTrackEventListeners(i2), this.trackPermissions(), t2.tracks.push(this), this.setVideoHandler(new rt(this)), this.settings = o2, o2.deviceId !== i2.getSettings().deviceId && i2.enabled && (this.settings = this.buildNewSettings({ deviceId: i2.getSettings().deviceId })), this.pluginsManager = new Lt(this, s2), this.mediaStreamPluginsManager = new yi(s2, n2), this.setFirstTrackId(this.trackId), this.eventBus.localAudioUnmutedNatively.subscribe(this.handleTrackUnmute), B2 && r2 === "regular" && Pt() && document.addEventListener("visibilitychange", this.handleVisibilityChange);
    }
    clone(t2) {
      let i2 = this.nativeTrack.clone();
      t2.nativeStream.addTrack(i2);
      ...
      return c2(this, null, function* () {
        ...
        if (t2 !== this.enabled) {
          if (this.source === "regular") {
            let r2;
            t2 ? r2 = yield this.replaceTrackWith(this.settings) : r2 = yield this.replaceTrackWithBlank(), yield this.replaceSender(r2, t2), (i2 = this.nativeTrack) == null || i2.stop(), this.nativeTrack = r2, yield ue(a6.prototype, this, "setEnabled").call(this, t2), t2 && (yield this.pluginsManager.waitForRestart(), yield this.processPlugins(), this.settings = this.buildNewSettings({ deviceId: r2.getSettings().deviceId })), this.videoHandler.updateSinks();
          }
    ...
    getPluginsMetrics() {
      let t2 = {};
      for (let i2 of this.mediaStreamPluginsManager.plugins) i2.getMetrics && (t2[i2.getName()] = i2.getMetrics());
      return t2;
    }
    addPlugin(t2, i2) {
      return c2(this, null, function* () {
    ...
    replaceTrackWith(t2) {
      return c2(this, null, function* () {
        ...
        try {
          let r2 = yield qr(t2);
          return this.addTrackEventListeners(r2), this.eventBus.analytics.publish(y2.mediaConstraints({ requestedConstraints: { video: t2.toConstraints() }, appliedConstraints: { video: r2.getConstraints() }, trackSettings: { video: r2.getSettings() } })), l2.d(this.TAG, "replaceTrack, Previous track stopped", i2, "newTrack", r2), this.settings.deviceId === "default" && (this.settings = this.buildNewSettings({ deviceId: this.nativeTrack.getSettings().deviceId })), r2;
        } catch (r2) {
          let s2 = r2;
          if (s2.code === k2.TracksErrors.CANT_ACCESS_CAPTURE_DEVICE || s2.code === k2.TracksErrors.SYSTEM_DENIED_PERMISSION) {
          ...
          let o2 = yield qr(this.settings);
          throw this.addTrackEventListeners(o2), this.eventBus.analytics.publish(y2.mediaConstraints({ requestedConstraints: { video: this.settings.toConstraints() }, appliedConstraints: { video: o2.getConstraints() }, trackSettings: { video: o2.getSettings() } })), yield this.replaceSender(o2, this.enabled), this.nativeTrack = o2, yield this.processPlugins(), this.videoHandler.updateSinks(), this.isPublished && this.eventBus.analytics.publish(y2.publish({ error: s2 })), s2;
        }
      });
    }
    replaceTrackWithBlank() {
      return c2(this, null, function* () {
        let t2 = this.nativeTrack, i2 = Te.getEmptyVideoTrack(t2);
  ...
  var x2 = class a7 extends it {
    constructor(t2, i2, r2, s2) {
      ...
      this.disableNoneLayerRequest = !!s2, this.setVideoHandler(new rt(this));
    }
    setTrackId(t2) {
      this.bizTrackId = t2;
    }
    ...
    setEnabled(t2) {
      return c2(this, null, function* () {
        t2 !== this.enabled && (ue(a7.prototype, this, "setEnabled").call(this, t2), this.videoHandler.updateSinks(true));
      });
    }
    ...
    addSink(t2, i2 = true) {
      return c2(this, null, function* () {
        ye(this.nativeTrack) ? yield this.requestLayer(this.preferredLayer, "addSink") : (ue(a7.prototype, this, "addSink").call(this, t2), i2 && (yield this.updateLayer("addSink"))), this.pushInHistory("uiSetLayer-high");
      });
    }
    removeSink(t2, i2 = true) {
      return c2(this, null, function* () {
        ue(a7.prototype, this, "removeSink").call(this, t2), i2 && (yield this.updateLayer("removeSink")), this._degraded = false, this.pushInHistory("uiSetLayer-none");
      });
    }
    getSimulcastDefinitions() {
      return [...this._layerDefinitions];
  ...
  var fe = class extends Ze {
    ...
    getTrackEncodings(t2, i2) {
      let r2 = [];
      if (t2 instanceof K) if (i2.length > 0) l2.d(this.TAG, "Simulcast enabled with layers", i2), r2.push(...i2);
      else {
        let s2 = { active: this.nativeStream.active };
        t2.settings.maxBitrate && !$e && (s2.maxBitrate = t2.settings.maxBitrate), r2.push(s2);
      }
      return r2;
    }
  };
  ...
  var ga = (a10) => {
    let e = a10.kind || a10.mediaType;
    return !e || e === "video";
  };
  var Ta = (a10, e) => !e || !a10.trackIdentifier ? true : a10.trackIdentifier === e;
  var fa = (a10) => {
    var e, t2;
    return { frames: a10.frames, framesPerSecond: a10.framesPerSecond, framesDropped: a10.framesDropped, width: (e = a10.width) != null ? e : a10.frameWidth, height: (t2 = a10.height) != null ? t2 : a10.frameHeight, timestamp: a10.timestamp };
  };
  var Xo = (a10, e) => {
    if (!(!$(a10.frames) || !$(e == null ? void 0 : e.sourceFrames) || !$(a10.timestamp) || !$(e == null ? void 0 : e.sourceTimestamp))) return Ei(a10.frames, e == null ? void 0 : e.sourceFrames, a10.timestamp, e == null ? void 0 : e.sourceTimestamp) * 1e3;
  };
  var Zo = (a10, e) => $(a10.framesPerSecond) ? a10.framesPerSecond : Xo(a10, e);
  var va = (a10) => {
    if (a10) return { none: a10.none || 0, cpu: a10.cpu || 0, bandwidth: a10.bandwidth || 0, other: a10.other || 0 };
  };
  var en2 = (a10, e) => {
    var i2, r2, s2;
    if (!a10) return;
    let t2 = (s2 = (r2 = (i2 = e.transceiver) == null ? void 0 : i2.sender) == null ? void 0 : r2.track) == null ? void 0 : s2.id;
    for (let o2 of a10.values()) {
      if (o2.type !== "track") continue;
      let n2 = o2;
      if (ga(n2) && Ta(n2, t2)) return fa(n2);
    }
  };
  var tn2 = (a10, e) => sn2(a10, e) || en2(a10, e);
  var Ma = (a10, e, t2, i2) => c2(void 0, null, function* () {
    var o2;
    let r2, s2 = {};
    if ((o2 = e.transceiver) != null && o2.sender.track) {
      try {
        r2 = yield e.transceiver.sender.getStats();
        let n2 = {}, d2 = {}, u2 = {}, p2 = e.type === "video" ? tn2(r2, e) : void 0;
        r2 == null || r2.forEach((h2) => {
          switch (h2.type) {
            case "outbound-rtp":
              d2[h2.id] = h2;
              break;
            case "remote-inbound-rtp":
              ...
              break;
            case "codec":
              n2[h2.id] = h2.mimeType;
              break;
            default:
              break;
          }
        }), Object.keys(m({}, d2)).forEach((h2) => {
          var De, Tt, ft, O2, Q2, vs, Ms;
          let T = (De = d2[h2]) == null ? void 0 : De.codecId, g2 = T ? n2[T] : void 0, f2;
          g2 && (f2 = g2.substring(g2.indexOf("/") + 1));
          let P2 = M2(m({}, d2[h2]), { rid: (Tt = d2[h2]) == null ? void 0 : Tt.rid }), v2 = va(P2.qualityLimitationDurations), A2 = M2(m({}, P2), { qualityLimitationDurations: v2 }), W2 = A2, se = (Ms = (vs = A2.trackIdentifier) != null ? vs : (Q2 = (O2 = (ft = e.transceiver) == null ? void 0 : ft.sender) == null ? void 0 : O2.track) == null ? void 0 : Q2.id) != null ? Ms : e.trackId, U2 = u2[P2.ssrc], ae = e.type === "video" ? on2(p2, A2.framesEncoded, i2 == null ? void 0 : i2[h2]) : {};
          s2[h2] = M2(m(m({}, A2), ae), { trackIdentifier: se, bitrate: wt("bytesSent", W2, i2 == null ? void 0 : i2[h2]), packetsLost: U2 == null ? void 0 : U2.packetsLost, jitter: U2 == null ? void 0 : U2.jitter, roundTripTime: U2 == null ? void 0 : U2.roundTripTime, totalRoundTripTime: U2 == null ? void 0 : U2.totalRoundTripTime, peerName: t2, peerID: e.peerId, enabled: e.enabled, codec: f2 });
        });
      } catch (n2) {
  ...
  var ya = (a10, e, t2, i2) => c2(void 0, null, function* () {
    var u2, p2, h2, T, g2, f2;
    let r2;
    try {
      r2 = yield (u2 = e.transceiver) == null ? void 0 : u2.receiver.getStats();
    } catch (P2) {
      a10.analytics.publish(y2.rtcStatsFailed(S2.WebrtcErrors.StatsFailed("TRACK", `Error getting remote track stats ${e.trackId} - ${P2.message}`))), l2.w("[HMSWebrtcStats]", "Error in getting remote track stats", e, P2);
    }
    let s2 = rn2(r2), o2 = s2, n2 = wt("bytesReceived", o2, i2), d2 = es("packetsLost", o2, i2);
    return s2 != null && s2.remote && Object.assign(s2.remote, { packetsLostRate: es("packetsLost", s2.remote, i2 == null ? void 0 : i2.remote) }), s2 && M2(m({}, s2), { trackIdentifier: (f2 = (g2 = s2.trackIdentifier) != null ? g2 : (T = (h2 = (p2 = e.transceiver) == null ? void 0 : p2.receiver) == null ? void 0 : h2.track) == null ? void 0 : T.id) != null ? f2 : e.trackId, bitrate: n2, packetsLostRate: d2, peerID: e.peerId, enabled: e.enabled, peerName: t2, codec: s2.codec });
  });
  var rn2 = (a10) => {
    let e, t2, i2 = {};
    a10 == null || a10.forEach((n2) => {
      switch (n2.type) {
        case "inbound-rtp":
          e = n2;
          break;
    ...
    if (r2 && (s2 = r2.substring(r2.indexOf("/") + 1)), !e) return;
    let o2 = va(e.qualityLimitationDurations);
    return Object.assign(e, m({ remote: t2, codec: s2 }, o2 ? { qualityLimitationDurations: o2 } : {}));
  };
  var sn2 = (a10, e) => {
    var i2, r2, s2;
    if (!a10) return;
    let t2 = (s2 = (r2 = (i2 = e.transceiver) == null ? void 0 : i2.sender) == null ? void 0 : r2.track) == null ? void 0 : s2.id;
    for (let o2 of a10.values()) {
      if (o2.type !== "media-source") continue;
      let n2 = o2;
      if (ga(n2) && Ta(n2, t2)) return fa(n2);
    }
  };
  var an2 = (a10, e, t2, i2) => {
    if (!$(a10) || !$(e) || !$(t2) || !$(i2)) return;
    let r2 = a10 - t2, s2 = e - i2;
    return Math.max(0, r2 - s2);
  };
  var on2 = (a10, e, t2) => {
    let i2 = an2(a10 == null ? void 0 : a10.frames, e, t2 == null ? void 0 : t2.sourceFrames, t2 == null ? void 0 : t2.framesEncoded);
    return { sourceFrameWidth: a10 == null ? void 0 : a10.width, sourceFrameHeight: a10 == null ? void 0 : a10.height, sourceFrames: a10 == null ? void 0 : a10.frames, sourceFramesDropped: i2, sourceFramesPerSecond: a10 ? Zo(a10, t2) : void 0, sourceTimestamp: a10 == null ? void 0 : a10.timestamp, sourceStatsAvailable: !!a10 };
  };
  var ts = (a10, e, t2) => {
    let i2 = nn2(e), r2 = wt(a10 === "publish" ? "bytesSent" : "bytesReceived", i2, t2 && t2[a10]);
  ...
  var Ea = (a10, e) => Array.from(new Set(a10.concat(e)));
  var wt = (a10, e, t2) => es(a10, e, t2) * 8;
  var es = (a10, e, t2) => {
    let i2 = e && e[a10], r2 = t2 ? t2[a10] : null;
    return [e, t2, $(i2), $(r2)].every((o2) => !!o2) ? Ei(i2, r2, e == null ? void 0 : e.timestamp, t2 == null ? void 0 : t2.timestamp) * 1e3 : 0;
  };
  var Ei = (a10, e, t2, i2) => $(a10) && $(e) && t2 && i2 ? (a10 - e) / (t2 - i2) : 0;
  var Pi = class {
    constructor(e, t2, i2, r2) {
      ...
      this.updateLocalPeerStats = () => c2(this, null, function* () {
        ...
        let s3 = r3 && ts("subscribe", r3, e2), { packetsLost: o2, jitter: n2 } = ka(r3), d2 = Ei(o2, (T = e2 == null ? void 0 : e2.subscribe) == null ? void 0 : T.packetsLost, s3 == null ? void 0 : s3.timestamp, (g2 = e2 == null ? void 0 : e2.subscribe) == null ? void 0 : g2.timestamp), u2 = s3 && Object.assign(s3, { packetsLostRate: d2, jitter: n2, packetsLost: o2 });
        this.peerStats[this.localPeerID] = { publish: i3, subscribe: u2 };
      });
      this.updateRemoteTrackStats = () => c2(this, null, function* () {
        var i3;
        let e2 = Array.from(this.store.getTracksMap().values()).filter((r3) => r3 instanceof x2 || r3 instanceof oe), t3 = e2.map((r3) => r3.trackId);
        Object.keys(this.remoteTrackStats).forEach((r3) => {
          t3.includes(r3) || delete this.remoteTrackStats[r3];
        });
        for (let r3 of e2) {
          let s3 = r3.peerId && ((i3 = this.store.getPeerById(r3.peerId)) == null ? void 0 : i3.name), o2 = this.getRemoteTrackStats(r3.trackId), n2 = yield ya(this.eventBus, r3, s3, o2);
          n2 && (this.remoteTrackStats[r3.trackId] = n2);
        }
      });
      this.updateLocalTrackStats = () => c2(this, null, function* () {
        var i3;
        let e2 = this.store.getLocalPeerTracks().reduce((r3, s3) => (r3[s3.getTrackIDBeingSent()] = s3, r3), {}), t3 = Ea(Object.keys(this.localTrackStats), Object.keys(e2));
        for (let r3 of t3) {
          let s3 = e2[r3];
          if (s3) {
            let o2 = (i3 = this.store.getLocalPeer()) == null ? void 0 : i3.name, n2 = yield Ma(this.eventBus, s3, o2, this.localTrackStats[r3]);
  ...
  var bi = class {
    ...
    setPeerConnections({ publish: e, subscribe: t2 }) {
      this.hmsStats ? this.hmsStats.setPeerConnections({ publish: e, subscribe: t2 }) : this.hmsStats = new Pi(this.store, this.eventBus, e, t2);
    }
    start() {
      return c2(this, null, function* () {
        if (this.isMonitored) {
    ...
    startLoop() {
      return c2(this, null, function* () {
        for (; this.isMonitored; ) yield this.handleStatsUpdate(), yield X2(this.interval);
      });
    }
    cleanup() {
  ...
  var nt = class {
    ...
    get isHandRaised() {
      var e;
      return !!((e = this.groups) != null && e.includes(Ie));
    }
    updateRole(e) {
      this.role = e;
    }
  ...
  ct.makePeerId = () => v4_default();
  var Qe = class extends nt {
    constructor(t2) {
      super(M2(m({}, t2), { peerId: ct.makePeerId(), isLocal: true }));
      this.isLocal = true;
      this.auxiliaryTracks = [];
  ...
  var ke = (a10, e) => new _t({ peerId: a10.peer_id, name: a10.info.name, role: e.getPolicyForRole(a10.role), customerUserId: a10.info.user_id, metadata: a10.info.data, groups: a10.groups, type: a10.info.type });
  var Ii = class {
    constructor(e, t2, i2) {
      this.transport = e;
      this.store = t2;
  ...
  var Ve = class extends import_eventemitter2.EventEmitter2 {
    on(e, t2) {
  ...
  var Ai = class extends Ve {
    ...
    getAudioElement() {
      ...
      }), this.audioContextManager = new dt(t2), t2;
    }
  };
  var Ri = class extends Ve {
    constructor() {
      super(...arguments);
  ...
  var Hi = { audio: { list: [], currentIndex: -1, isAutoplayOn: true }, video: { list: [], currentIndex: -1, isAutoplayOn: true } };
  var Nt = class extends Ve {
    constructor(t2, i2) {
      super();
      this.sdk = t2;
      this.eventBus = i2;
      this.state = { audio: m({}, Hi.audio), video: m({}, Hi.video) };
      ...
      this.addTrack = (t3, i3) => c2(this, null, function* () {
        yield this.sdk.addTrack(t3, i3), l2.d(this.TAG, "Playlist track added", mi(t3));
      });
      this.removeTrack = (t3) => c2(this, null, function* () {
        yield this.sdk.removeTrack(t3, true), l2.d(this.TAG, "Playlist track removed", t3);
      });
      this.audioManager = new Ai(), this.videoManager = new Ri(), this.addListeners();
    }
    getList(t2 = "audio") {
    ...
    cleanup() {
      this.state = { audio: m({}, Hi.audio), video: m({}, Hi.video) }, this.eventBus.localAudioEnabled.unsubscribe(this.handlePausePlaylist), this.eventBus.localVideoEnabled.unsubscribe(this.handlePausePlaylist), this.audioManager.stop(), this.videoManager.stop();
    }
    onProgress(t2) {
  ...
  var G2 = (a10) => a10.room;
  var ln2 = (a10) => a10.errors;
  var Gm = createSelector(ln2, (a10) => a10.length === 0 ? null : a10.at(-1));
  var Wm = createSelector(G2, (a10) => a10.id);
  var Z2 = (a10) => a10.peers;
  var Ci = (a10) => a10.messages.byID;
  var Pa = (a10) => a10.messages.allIDs;
  var N2 = (a10) => a10.tracks;
  var ba = (a10) => a10.settings;
  var is = (a10) => a10.appData;
  var un2 = (a10) => a10.speakers;
  var Fe = createSelector([G2], (a10) => a10 && a10.isConnected);
  var qm = createSelector([Fe, G2], (a10, e) => a10 ? e.peerCount !== void 0 ? e.peerCount || 1 : e.peers.length : Math.max(e.peerCount !== void 0 ? e.peerCount : e.peers.length - 1, 0));
  var pn2 = (a10) => a10.hideLocalPeer;
  var Ee = createSelector([G2, Z2, pn2], (a10, e, t2) => t2 ? a10.peers.filter((i2) => a10.localPeer !== i2).map((i2) => e[i2]) : a10.peers.map((i2) => e[i2]));
  var hn = createSelector(N2, (a10) => Object.values(a10));
  var ne = createSelector(G2, Z2, (a10, e) => e[a10.localPeer]);
  var Ae = createSelector(G2, (a10) => a10.localPeer);
  var jm = createSelector(ne, (a10) => a10 == null ? void 0 : a10.name);
  var Qm = createSelector(ne, (a10) => a10 == null ? void 0 : a10.roleName);
  var me = createSelector(ne, (a10) => a10 == null ? void 0 : a10.audioTrack);
  var ie = createSelector(ne, (a10) => a10 == null ? void 0 : a10.videoTrack);
  var mn = createSelector(ne, (a10) => a10 == null ? void 0 : a10.auxiliaryTracks);
  var Ia = createSelector([me, ie, mn], (a10, e, t2) => {
    let i2 = t2 ? [...t2] : [];
    return a10 && i2.unshift(a10), e && i2.unshift(e), i2;
  });
  var Jm = createSelector(Ee, (a10) => a10.filter((e) => !e.isLocal));
  var zm = createSelector(Z2, un2, (a10, e) => {
  ...
  var rs = (a10) => {
    let e = ne(a10);
    return Xe(a10, e == null ? void 0 : e.videoTrack);
  };
  var Aa = (a10) => {
    let e = ne(a10);
    return As(a10, e == null ? void 0 : e.videoTrack);
  };
  var ss = createSelector(ne, N2, (a10, e) => {
    let { video: t2, audio: i2 } = We(e, a10);
    return !!(t2 || i2);
  });
  var Sn = createSelector(Z2, N2, (a10, e) => {
    let t2;
    for (let i2 in a10) {
      let r2 = a10[i2], { video: s2, audio: o2 } = We(e, r2);
      if (s2) return r2;
      o2 && !t2 && (t2 = r2);
    }
    return t2;
  });
  var Xm = createSelector(Sn, (a10) => !!a10);
  var Zm = createSelector(Z2, N2, (a10, e) => {
    for (let t2 in a10) {
      let i2 = a10[t2], { audio: r2, video: s2 } = We(e, i2);
      if (!s2 && r2) return i2;
    }
  });
  var eS = createSelector(Z2, N2, (a10, e) => {
    let t2 = [], i2 = [];
    for (let r2 in a10) {
      let s2 = a10[r2], { video: o2, audio: n2 } = We(e, s2);
      o2 ? t2.push(s2) : n2 && i2.push(s2);
    }
    return t2.concat(i2);
  });
  var tS = createSelector(Z2, N2, (a10, e) => {
    for (let t2 in e) {
      let i2 = e[t2];
      if (yt(i2) && Mt(i2) && i2.peerId) return a10[i2.peerId];
    }
  });
  var iS = createSelector(Z2, N2, (a10, e) => {
    for (let t2 in e) {
      let i2 = e[t2];
      if (pi(i2) && i2.peerId) return a10[i2.peerId];
    }
  });
  var rS = createSelector(hn, (a10) => a10.filter(Is));
  var sS = createSelector(Pa, (a10) => a10.length);
  var aS = createSelector(Ci, (a10) => Object.values(a10).filter((e) => !e.read).length);
  var Ot = createSelector(Pa, Ci, (a10, e) => {
    let t2 = [];
    return a10.forEach((i2) => {
      t2.push(e[i2]);
    }), t2;
  });
  var gn = createSelector(Ot, (a10) => a10.filter((e) => {
    var t2;
    return !e.recipientPeer && !(e.recipientRoles && ((t2 = e.recipientRoles) == null ? void 0 : t2.length) > 0);
  }));
  var oS = createSelector(gn, (a10) => a10.filter((e) => !e.read).length);
  var ce = createSelector([G2], (a10) => a10 && a10.roomState);
  var Ra = createSelector(ce, (a10) => a10 === "Preview");
  var nS = createSelector(G2, (a10) => a10.roomState !== "Disconnected");
  var cS = createSelector(G2, (a10) => !a10.transcriptions || a10.transcriptions.length <= 0 ? false : a10.transcriptions.some((e) => e.mode === "caption" && e.state === "started"));
  var Pe = (a10) => a10.roles;
  var dS = createSelector([Pe], (a10) => Object.keys(a10));
  var lt = createSelector([ne, Pe], (a10, e) => a10 != null && a10.roleName ? e[a10.roleName] : null);
  var Tn = (a10) => {
    var e;
    return (e = a10.preview) == null ? void 0 : e.asRole;
  };
  var Ha = createSelector([Tn, Pe], (a10, e) => a10 ? e[a10] : null);
  var lS = createSelector([lt], (a10) => {
    var e;
    return (e = a10 == null ? void 0 : a10.subscribeParams) != null && e.subscribeToRoles ? a10.subscribeParams.subscribeToRoles.length > 0 : false;
  });
  var Ca = createSelector(lt, (a10) => a10 == null ? void 0 : a10.permissions);
  var uS = createSelector(G2, (a10) => a10.recording);
  var pS = createSelector(G2, (a10) => a10.rtmp);
  var hS = createSelector(G2, (a10) => a10.hls);
  var mS = createSelector(G2, (a10) => a10.transcriptions);
  var SS = createSelector(G2, (a10) => a10.sessionId);
  var gS = createSelector(G2, (a10) => a10.startedAt);
  var TS = createSelector(G2, (a10) => !!a10.isLargeRoom);
  var fS = createSelector(G2, (a10) => !!a10.isEffectsEnabled);
  var vS = createSelector(G2, (a10) => !!a10.isVBEnabled);
  var MS = createSelector(G2, (a10) => a10.effectsKey);
  var La = (a10) => a10.polls;
  var PS = createSelector(Ee, (a10) => a10.filter((e) => e.isHandRaised));
  var fn2 = (a10) => a10.whiteboards;
  var bS = createSelector(fn2, (a10) => Object.values(a10)[0]);
  var wa = (a10 = "audio") => (e) => e.playlist[a10].list;
  var as = (a10 = "audio") => (e) => e.playlist[a10].selection;
  var _a = (a10 = "audio") => (e) => e.playlist[a10].progress;
  var Na = (a10 = "audio") => (e) => e.playlist[a10].currentTime;
  var Oa = (a10 = "audio") => (e) => e.playlist[a10].playbackRate;
  var xa = (a10 = "audio") => (e) => e.playlist[a10].volume;
  var Ua = (a10 = "audio") => createSelector(wa(a10), (e) => Object.values(e));
  var Ba = (a10 = "audio") => createSelector(wa(a10), as(a10), (e, t2) => {
    if (t2.id) return e[t2.id];
  });
  var Va = { selection: as("audio"), progress: _a("audio"), currentTime: Na("audio"), playbackRate: Oa("audio"), volume: xa("audio"), list: Ua("audio"), selectedItem: Ba("audio") };
  var Fa = { selection: as("video"), progress: _a("video"), currentTime: Na("video"), playbackRate: Oa("video"), volume: xa("video"), list: Ua("video"), selectedItem: Ba("video") };
  function H2(a10) {
  ...
  var vn2 = (a10, e) => e;
  var Mn = (a10, e) => e;
  var ee = createSelector([Z2, os], (a10, e) => e ? a10[e] : null);
  var ns = createSelector([N2, Ut], (a10, e) => e ? a10[e] : null);
  var yn = createSelector([N2, Ut], (a10, e) => {
    if (!e) return null;
    let t2 = a10[e];
    return (t2 == null ? void 0 : t2.type) === "video" ? t2 : null;
  });
  var kn = createSelector([N2, Ut], (a10, e) => {
    if (!e) return null;
    let t2 = a10[e];
    return (t2 == null ? void 0 : t2.type) === "audio" ? t2 : null;
  });
  var En = createSelector([N2, Ut], (a10, e) => {
    if (!e) return null;
    let t2 = a10[e];
    return (t2 == null ? void 0 : t2.type) === "audio" && (t2 == null ? void 0 : t2.source) === "screen" ? t2 : null;
  });
  var Pn = createSelector([N2, Ut], (a10, e) => {
    if (!e) return null;
    let t2 = a10[e];
    return (t2 == null ? void 0 : t2.type) === "video" && (t2 == null ? void 0 : t2.source) === "screen" ? t2 : null;
  });
  var bn = createSelector([La, Mn], (a10, e) => e ? a10[e] : null);
  var re = H2(ee);
  var OS2 = H2(createSelector([is, vn2], (a10, e) => {
    if (a10) return e ? a10[e] : a10;
  }));
  var BS = H2(createSelector(ee, (a10) => a10 == null ? void 0 : a10.name));
  var VS = H2(createSelector(ee, (a10) => a10 == null ? void 0 : a10.type));
  var Li = H2(ns);
  var Wa = H2(yn);
  var FS = H2(kn);
  var GS = H2(En);
  ...
  var $a = (a10, e) => e ? a10.speakers[e] : null;
  var qS = H2(createSelector($a, (a10) => (a10 == null ? void 0 : a10.audioLevel) || 0));
  var Rn = (a10, e) => {
    let t2 = An(e)(a10);
    return $a(a10, t2 == null ? void 0 : t2.id);
  };
  var jS = H2(createSelector(Rn, (a10) => (a10 == null ? void 0 : a10.audioLevel) || 0));
  var QS = H2((a10, e) => {
  ...
  var JS = H2((a10, e) => {
    let t2 = ee(a10, e);
    if (t2) {
      let i2 = t2 == null ? void 0 : t2.auxiliaryTracks.find((r2) => vt(a10.tracks[r2]));
      return i2 ? a10.tracks[i2] : void 0;
    }
  });
  var zS = H2(createSelector(N2, ee, (a10, e) => {
  ...
  var YS = H2(createSelector(N2, ee, (a10, e) => {
    let t2 = e == null ? void 0 : e.auxiliaryTracks.find((i2) => {
      let r2 = a10[i2];
      return yt(r2) && vt(r2);
    });
  ...
  var XS = H2(createSelector(N2, ee, (a10, e) => {
    let t2 = e == null ? void 0 : e.auxiliaryTracks.find((i2) => {
      let r2 = a10[i2];
      return pi(r2) && vt(r2);
    });
  ...
  var Ka = H2(createSelector(N2, ee, (a10, e) => We(a10, e)));
  var qa = (a10) => createSelector(Ka(a10), (e) => e.audio);
  var eg = H2((a10, e) => {
    let t2 = ee(a10, e);
    return Xe(a10, t2 == null ? void 0 : t2.audioTrack);
  });
  var tg = H2((a10, e) => {
    let t2 = ee(a10, e);
    return Xe(a10, t2 == null ? void 0 : t2.videoTrack);
  });
  var ja = H2((a10, e) => {
  ...
  var ig = H2((a10, e) => {
    let t2 = ee(a10, e);
    return ja(t2 == null ? void 0 : t2.audioTrack)(a10);
  });
  var rg = H2((a10, e) => {
    let t2 = qa(e)(a10);
    return ja(t2 == null ? void 0 : t2.id)(a10);
  });
  var Qa = H2((a10, e) => {
    let t2 = ns(a10, e);
    if (t2) {
  ...
  var sg = H2((a10, e) => {
    let t2 = ee(a10, e);
    return Qa(t2 == null ? void 0 : t2.audioTrack)(a10);
  });
  var ag = H2((a10, e) => {
    let t2 = qa(e)(a10);
    return Qa(t2 == null ? void 0 : t2.id)(a10);
  });
  var og = H2((a10, e) => {
    let t2 = ns(a10, e);
    if (t2) {
  ...
  var Ja = createSelector([Ot, Ae, os], (a10, e, t2) => {
  ...
  var za = createSelector([Ot, Ga], (a10, e) => {
    if (e) return a10.filter((t2) => {
      var i2, r2;
      return (i2 = t2.recipientRoles) != null && i2.length ? (r2 = t2.recipientRoles) == null ? void 0 : r2.includes(e) : false;
    });
  });
  var Hn = createSelector(Ot, (a10) => a10.filter((e) => {
    var t2;
    return !e.recipientPeer && !((t2 = e.recipientRoles) != null && t2.length);
  }));
  var Cn = createSelector([za, Ga], (a10) => a10 ? a10.filter((e) => !e.read).length : 0);
  var Ln = createSelector([Ja, os], (a10) => a10 ? a10.filter((e) => !e.read).length : 0);
  var ng = createSelector(Hn, (a10) => a10.filter((e) => !e.read).length);
  var cg = H2(Ja);
  var dg = H2(za);
  var lg = H2(Cn);
  var ug = H2(Ln);
  var Ya = H2(bn);
  var Eg = createSelector([Z2, N2], (a10, e) => Object.values(a10).map((i2) => {
    var r2;
    return { peer: i2, isAudioEnabled: i2.audioTrack ? (r2 = e[i2.audioTrack]) == null ? void 0 : r2.enabled : false };
  }));
  var Dn = (a10) => a10.roleChangeRequests[0] || null;
  var Pg = createSelector([Dn, Z2, Pe], (a10, e, t2) => a10 ? { requestedBy: a10.requestedBy ? e[a10.requestedBy] : void 0, role: t2[a10.roleName], token: a10.token } : null);
  var bg = createSelector([lt], (a10) => kt(a10));
  var Ig = createSelector([Ha], (a10) => kt(a10));
  var _n = createSelector([ie, N2], (a10, e) => {
    let t2 = null;
    return a10 && (t2 = e[a10]), (t2 == null ? void 0 : t2.plugins) || [];
  });
  var Nn = createSelector([me, N2], (a10, e) => {
    let t2 = null;
    return a10 && (t2 = e[a10]), (t2 == null ? void 0 : t2.plugins) || [];
  });
  var wi = { 0: "PEER_JOINED", 1: "PEER_LEFT", 8: "ROLE_UPDATED", 10: "NAME_UPDATED", 11: "METADATA_UPDATED", 12: "HAND_RAISE_CHANGED" };
  var Bt = { 0: "TRACK_ADDED", 1: "TRACK_REMOVED", 2: "TRACK_MUTED", 3: "TRACK_UNMUTED", 5: "TRACK_DEGRADED", 6: "TRACK_RESTORED", 4: "TRACK_DESCRIPTION_CHANGED" };
  var _i = { 0: "POLL_CREATED", 1: "POLL_STARTED", 2: "POLL_STOPPED", 4: "POLL_VOTES_UPDATED", 3: "POLLS_LIST" };
  var Xa = { TRANSCRIPTION_STATE_UPDATED: "TRANSCRIPTION_STATE_UPDATED" };
  var cs = "hmsNotification";
  var Ni = class {
    constructor(e) {
      this.id = 0;
      this.onNotification = (e2, t2) => {
        ...
        return this.eventEmitter.addListener(cs, i2), () => {
          this.eventEmitter.removeListener(cs, i2);
        };
      };
      this.store = e, this.eventEmitter = new import_eventemitter22.EventEmitter2({ maxListeners: Object.keys(Hr).length });
    }
    ...
    sendPeerUpdate(e, t2) {
      let i2 = this.store.getState(re(t2 == null ? void 0 : t2.id)) || t2, r2 = wi[e];
      if (r2 && i2) {
    ...
    sendTrackUpdate(e, t2) {
      let i2 = this.store.getState(Li(t2)), r2 = Bt[e];
      if (r2) {
        let s2 = this.createNotification(r2, i2, "info");
        this.emitEvent(s2);
      }
    ...
    sendPollUpdate(e, t2) {
      let i2 = _i[e], r2 = this.store.getState(Ya(t2));
      if (i2) {
    ...
    sendTranscriptionUpdate(e) {
      let t2 = this.createNotification(Xa.TRANSCRIPTION_STATE_UPDATED, e, "info");
      this.emitEvent(t2);
    }
    emitEvent(e) {
      this.eventEmitter.emit(cs, e);
    }
  ...
  function Za(a10) {
    return a10 instanceof oe || a10 instanceof x2;
  }
  var eo = (a10, e) => {
    let t2 = Vt(Object.keys(a10), Object.keys(e));
    for (let i2 of t2) {
      let r2 = a10[i2], s2 = e[i2];
      Je(r2, s2) ? (de(r2.auxiliaryTracks, s2.auxiliaryTracks) && (s2.auxiliaryTracks = r2.auxiliaryTracks), r2.groups && de(r2.groups, s2.groups) && (s2.groups = r2.groups), Object.assign(r2, s2)) : us(r2, s2) ? delete a10[i2] : xi(r2, s2) && (a10[i2] = s2);
    }
  };
  var to = (a10, e) => {
    let t2 = Vt(Object.keys(a10), Object.keys(e));
    for (let i2 of t2) {
      let r2 = a10[i2], s2 = e[i2];
      Je(r2, s2) ? (ls(r2, s2), Object.assign(r2, s2)) : us(r2, s2) ? delete a10[i2] : xi(r2, s2) && (a10[i2] = s2);
    }
  };
  var io = (a10, e) => {
    let t2 = Vt(Object.keys(a10), Object.keys(e));
    for (let i2 of t2) {
      let r2 = a10[i2], s2 = e[i2];
      Je(r2, s2) ? (r2.questions && de(r2.questions, s2.questions) && (s2.questions = r2.questions), Object.assign(r2, s2)) : xi(r2, s2) && (a10[i2] = s2);
    }
  };
  var ds = (a10, e) => {
    let t2 = Vt(Object.keys(a10), Object.keys(e));
    for (let i2 of t2) {
      let r2 = a10[i2], s2 = e[i2];
      Je(r2, s2) ? Object.assign(r2, s2) : us(r2, s2) ? delete a10[i2] : xi(r2, s2) && (a10[i2] = s2);
    }
  };
  var ro = (a10, e, t2) => {
    let i2 = t2.reduce((s2, o2) => (s2[o2.firstTrackId] = Object.values(e[o2.getTrackIDBeingSent()] || {}).sort((n2, d2) => !n2.rid || !d2.rid ? 0 : n2.rid < d2.rid ? -1 : 1), s2), {}), r2 = Vt(Object.keys(a10), Object.keys(i2));
    for (let s2 of r2) {
      if (!i2[s2]) {
        delete a10[s2];
        continue;
  ...
  var ls = (a10, e) => {
    a10.plugins && de(a10.plugins, e.plugins) && (e.plugins = a10.plugins), a10.type === "video" && a10.layerDefinitions && de(a10.layerDefinitions, e.layerDefinitions) && (e.layerDefinitions = a10.layerDefinitions);
  };
  var Je = (a10, e) => a10 && e;
  var us = (a10, e) => a10 && !e;
  var xi = (a10, e) => !a10 && e;
  ...
  var _2 = class a8 {
    ...
    static enrichTrack(e, t2) {
      ...
      t2 instanceof oe && (e.volume = t2.getVolume() || 0), a8.updateDeviceID(e, t2), a8.enrichLocalTrack(e, t2), e.type === "video" && (e.source === "screen" ? (e.displaySurface = i2.displaySurface, a8.enrichScreenTrack(e, t2)) : e.source === "regular" && (e.facingMode = i2.facingMode), e.height = i2.height, e.width = i2.width, a8.enrichVideoTrack(e, t2)), a8.enrichPluginsDetails(e, t2);
    }
    static enrichLocalTrack(e, t2) {
      (t2 instanceof K || t2 instanceof he) && (e.isPublished = t2.isPublished);
    }
    static updateDeviceID(e, t2) {
      var i2;
      t2 instanceof K || t2 instanceof he ? e.deviceID = t2.settings.deviceId : e.deviceID = (i2 = t2.getMediaTrackSettings()) == null ? void 0 : i2.deviceId;
    }
    static enrichVideoTrack(e, t2) {
      t2 instanceof x2 && (e.layer = t2.getLayer(), e.preferredLayer = t2.getPreferredLayer(), e.degraded = t2.degraded), (t2 instanceof x2 || t2 instanceof K) && (de(t2.getSimulcastDefinitions(), e.layerDefinitions) || (e.layerDefinitions = t2.getSimulcastDefinitions()));
    }
    ...
    static enrichPluginsDetails(e, t2) {
      (t2 instanceof K || t2 instanceof he) && (de(t2.getPlugins(), e.plugins) || (e.plugins = t2.getPlugins()));
    }
  ...
  var Ft = class {
    ...
    pause() {
      return c2(this, null, function* () {
        let e = this.type === "audio" ? Va : Fa, t2 = this.store.getState(e.selection);
        if (!t2.id) {
  ...
  var Bi = class {
    ...
    start() {
      return c2(this, null, function* () {
        ...
        let e = this.store.getState(Fe);
        b2.d("starting audio levels is connected to room", e), e && (yield this.monitorAudioLevels());
        let t2 = this.store.subscribe(this.monitorAudioLevels.bind(this), Fe);
        this.unsubs.push(t2);
      });
    }
    stop() {
    ...
    getAudioLevel(e, t2) {
      return c2(this, null, function* () {
        ...
        return { peerId: e.id, peerName: e.name, userId: e.customerUserId, level: r2 };
      });
    }
  ...
  var oo = "https://100ms.live/test-audio.wav";
  var Vi = class {
    constructor() {
      this.networkScores = [];
      this.lastPushedAt = 0;
  ...
  var xn = (a10) => !!a10 && !isNaN(a10);
  var le = (a10) => a10[a10.length - 1];
  var Ge = (a10, e) => {
    let t2 = a10.filter((i2) => xn(e(i2)));
      ...
      return c2(this, null, function* () {
        ...
        o2 == null || o2.forEach((P2) => {
          if (P2.type === "inbound-rtp") {
            let v2 = P2.kind === "audio" ? this.remoteAudioTrackStatsList : this.remoteVideoTrackStatsList, A2 = wt("bytesReceived", P2, le(v2));
            v2.push(M2(m({}, P2), { bitrate: A2 }));
          }
        });
      });
    }
    buildReport() {
      var P2, v2, A2, W2, se, U2, ae, De, Tt, ft;
      let e = (P2 = le(this.peerStatsList)) == null ? void 0 : P2.publish, t2 = (v2 = le(this.peerStatsList)) == null ? void 0 : v2.subscribe, i2 = e != null && e.responsesReceived ? ((e == null ? void 0 : e.totalRoundTripTime) || 0) / e.responsesReceived : 0, r2 = t2 != null && t2.responsesReceived ? ((t2 == null ? void 0 : t2.totalRoundTripTime) || 0) / t2.responsesReceived : 0, s2 = Number(((i2 + r2) / 2 * 1e3).toFixed(2)), o2 = ((A2 = le(this.remoteAudioTrackStatsList)) == null ? void 0 : A2.packetsReceived) || 0, n2 = ((W2 = le(this.remoteVideoTrackStatsList)) == null ? void 0 : W2.packetsReceived) || 0, d2 = this.localAudioTrackStatsList.map((O2) => O2 ? Ge(Object.values(O2), (Q2) => Q2.bitrate) : 0), u2 = this.localVideoTrackStatsList.map((O2) => O2 ? Ge(Object.values(O2), (Q2) => Q2.bitrate) : 0), p2 = ((se = le(this.remoteAudioTrackStatsList)) == null ? void 0 : se.jitter) || 0, h2 = ((U2 = le(this.remoteVideoTrackStatsList)) == null ? void 0 : U2.jitter) || 0, T = Math.max(p2, h2), g2 = le(this.localAudioTrackStatsList), f2 = le(this.localVideoTrackStatsList);
      return { combined: { roundTripTime: s2, packetsReceived: o2 + n2, packetsLost: (t2 == null ? void 0 : t2.packetsLost) || 0, bytesSent: (e == null ? void 0 : e.bytesSent) || 0, bytesReceived: (t2 == null ? void 0 : t2.bytesReceived) || 0, bitrateSent: Ge(this.peerStatsList, (O2) => {
        var Q2;
        return (Q2 = O2.publish) == null ? void 0 : Q2.bitrate;
      }), bitrateReceived: Ge(this.peerStatsList, (O2) => {
        var Q2;
        return (Q2 = O2.subscribe) == null ? void 0 : Q2.bitrate;
      }), jitter: T }, audio: { roundTripTime: s2, packetsReceived: o2, packetsLost: ((ae = le(this.remoteAudioTrackStatsList)) == null ? void 0 : ae.packetsLost) || 0, bytesReceived: ((De = le(this.remoteAudioTrackStatsList)) == null ? void 0 : De.bytesReceived) || 0, bitrateSent: Ge(d2, (O2) => O2), bitrateReceived: Ge(this.remoteAudioTrackStatsList, (O2) => O2.bitrate), bytesSent: g2 ? Object.values(g2).reduce((O2, Q2) => O2 + (Q2.bytesSent || 0), 0) : 0, jitter: p2 }, video: { roundTripTime: s2, packetsLost: ((Tt = le(this.remoteVideoTrackStatsList)) == null ? void 0 : Tt.packetsLost) || 0, bytesReceived: ((ft = le(this.remoteVideoTrackStatsList)) == null ? void 0 : ft.bytesReceived) || 0, packetsReceived: n2, bitrateSent: Ge(u2, (O2) => O2), bitrateReceived: Ge(this.remoteVideoTrackStatsList, (O2) => O2.bitrate), bytesSent: f2 ? Object.values(f2).reduce((O2, Q2) => O2 + (Q2.bytesSent || 0), 0) : 0, jitter: h2 } };
    }
  };
  var Un = ((n2) => (n2[n2.STARTING = 0] = "STARTING", n2[n2.INIT_FETCHED = 1] = "INIT_FETCHED", n2[n2.SIGNAL_CONNECTED = 2] = "SIGNAL_CONNECTED", n2[n2.ICE_ESTABLISHED = 3] = "ICE_ESTABLISHED", n2[n2.MEDIA_CAPTURED = 4] = "MEDIA_CAPTURED", n2[n2.MEDIA_PUBLISHED = 5] = "MEDIA_PUBLISHED", n2[n2.COMPLETED = 6] = "COMPLETED", n2))(Un || {});
  var no;
  var co;
  var Gi = class {
    constructor(e, t2, i2, r2, s2 = so) {
      this.sdk = e;
      this.sdkListener = t2;
      ...
      this.onNetworkQuality = (no = this.sdkListener.onNetworkQuality) == null ? void 0 : no.bind(this.sdkListener);
      this.onPreview = this.sdkListener.onPreview.bind(this.sdkListener);
      this.onDeviceChange = (co = this.sdkListener.onDeviceChange) == null ? void 0 : co.bind(this.sdkListener);
      ...
      this.statsCollector = new Fi(e), this.state = 0;
    }
    get state() {
      return this._state;
    }
  ...
  var Wi = (a10, e, t2) => c2(void 0, null, function* () {
    let r2 = Error("something went wrong during fetch");
    for (let s2 = 0; s2 < 4; s2++) try {
      let o2 = yield fetch(a10, e), _t2 = yield o2.text(), n2 = JSON.parse(_t2);
  ...
  var Gt = class {
    ...
    requestPermission(e) {
      return c2(this, null, function* () {
        try {
          ...
          throw Oe(t2, this.sdk.localTrackManager.getErrorType(!!e.video, !!e.audio));
        }
      });
    }
    startCameraCheck(e) {
      return c2(this, null, function* () {
        ...
        this.sdk.store.setSimulcastEnabled(false), this.localPeer.role = M2(m({}, ut), { publishParams: M2(m({}, ut.publishParams), { allowed: ["video"] }) });
        let t2 = new xe().video(new J().deviceId(e || "default").build()).build(), i2 = yield (s2 = this.sdk) == null ? void 0 : s2.localTrackManager.getLocalTracks({ audio: false, video: true }, t2), r2 = i2 == null ? void 0 : i2.find((u2) => u2.type === "video");
    ...
    startMicCheck(s2) {
      return c2(this, arguments, function* ({ inputDevice: e, onError: t2, onStop: i2, time: r2 = ao }) {
        var u2, p2, h2, T;
    ...
    startConnectivityCheck(e, t2, i2, r2) {
      return c2(this, null, function* () {
        ...
        this.connectivityCheck = new Gi(this.sdk, this.sdkListener, e, t2, r2);
    ...
    initSdkWithLocalPeer(e) {
      ...
      let t2 = new Qe({ name: "diagnostics-peer", role: ut, type: "regular" });
      (s2 = this.sdk) == null || s2.store.addPeer(t2);
      let i2 = new ze("diagnostics-room");
    ...
    getAuthToken(e) {
      return c2(this, null, function* () {
        ...
        let i2 = yield Wi(t2.toString(), { method: "GET" }, [429, 500, 501, 502, 503, 504, 505, 506, 507, 508, 509, 510, 511]), r2 = yield i2.json();
    ...
    getLocalAudioTrack(e) {
      return c2(this, null, function* () {
        ...
        this.localPeer.role = M2(m({}, ut), { publishParams: M2(m({}, ut.publishParams), { allowed: ["audio"] }) });
        let t2 = new xe().audio(new Y2().deviceId(e || "default").build()).build(), i2 = yield (r2 = this.sdk) == null ? void 0 : r2.localTrackManager.getLocalTracks({ audio: true, video: false }, t2);
  ...
  var $i = class {
    constructor(e, t2, i2) {
      ...
      this.sendPeerUpdateNotification = (e2, t3) => {
        let i3 = this.store.getState(re(t3.peerId)), r2 = wi[e2] || "peerUpdate";
        if (e2 === 8) this.syncRoomState(r2), this.updateMidCallPreviewRoomState(e2, t3);
        else if ([0, 1].includes(e2)) this.syncRoomState(r2), i3 || (i3 = this.store.getState(re(t3.peerId)));
        else if ([12, 13, 14].includes(e2)) this.syncRoomState(r2), i3 || (i3 = this.store.getState(re(t3.peerId)));
        else {
          let s2 = _2.convertPeer(t3);
          this.setState((o2) => {
            let n2 = o2.peers[s2.id];
            Je(n2, s2) && (de(n2.auxiliaryTracks, s2.auxiliaryTracks) && (n2.auxiliaryTracks = s2.auxiliaryTracks), Object.assign(n2, s2)), i3 = s2;
          }, r2);
        }
      ...
      this.store = e, this.sdk = t2, this.hmsNotifications = i2, this.sessionStore = new Ui(this.sdk, this.setSessionStoreValueLocally.bind(this)), this.actionBatcher = new Oi(e);
    }
    ...
    setPreferredLayer(e, t2) {
      return c2(this, null, function* () {
        ...
        if (i2) if (i2 instanceof x2) {
          if (t2 === "none") {
            b2.d("layer none will be ignored");
            return;
          }
          if (((r2 = this.store.getState(Wa(e))) == null ? void 0 : r2.preferredLayer) === t2) {
    ...
    setRemoteTrackEnabled(e, t2) {
      return c2(this, null, function* () {
        if (typeof e == "string") {
          let i2 = this.getTrackById(e);
          i2 && Za(i2) ? yield this.sdk.changeTrackState(i2, t2) : this.logPossibleInconsistency(`No remote track with ID ${e} found for change track state`);
    ...
    initDiagnostics() {
      let e = new Gt(this.sdk, { onJoin: this.onJoin.bind(this), onPreview: this.onPreview.bind(this), onRoomUpdate: this.onRoomUpdate.bind(this), onPeerUpdate: this.onPeerUpdate.bind(this), onTrackUpdate: this.onTrackUpdate.bind(this), onMessageReceived: this.onMessageReceived.bind(this), onError: this.onError.bind(this), onReconnected: this.onReconnected.bind(this), onReconnecting: this.onReconnecting.bind(this), onRoleChangeRequest: this.onRoleChangeRequest.bind(this), onRoleUpdate: this.onRoleUpdate.bind(this), onDeviceChange: this.onDeviceChange.bind(this), onChangeTrackStateRequest: this.onChangeTrackStateRequest.bind(this), onChangeMultiTrackStateRequest: this.onChangeMultiTrackStateRequest.bind(this), onRemovedFromRoom: this.onRemovedFromRoom.bind(this), onNetworkQuality: this.onNetworkQuality.bind(this), onSessionStoreUpdate: this.onSessionStoreUpdate.bind(this), onPollsUpdate: this.onPollsUpdate.bind(this), onWhiteboardUpdate: this.onWhiteboardUpdate.bind(this) });
    ...
    onRemovedFromRoom(e) {
      var r2;
      let t2 = this.store.getState(re((r2 = e.requestedBy) == null ? void 0 : r2.peerId));
    ...
    onDeviceChange(e) {
      let t2 = e.devices;
      if (!t2) return;
      let i2 = this.store.getState(ne);
      if (this.setState((r2) => {
        de(r2.devices.audioInput, t2.audioInput) || (r2.devices.audioInput = t2.audioInput), de(r2.devices.videoInput, t2.videoInput) || (r2.devices.videoInput = t2.videoInput), de(r2.devices.audioOutput, t2.audioOutput) || (r2.devices.audioOutput = t2.audioOutput);
    ...
    startScreenShare(e) {
      return c2(this, null, function* () {
        this.store.getState(ss) ? this.logPossibleInconsistency("start screenshare is called while it's on") : (yield this.sdk.startScreenShare(() => this.syncRoomState("screenshareStopped"), e), this.syncRoomState("startScreenShare"));
      });
    }
    stopScreenShare() {
      return c2(this, null, function* () {
        this.store.getState(ss) ? (yield this.sdk.stopScreenShare(), this.syncRoomState("stopScreenShare")) : this.logPossibleInconsistency("stop screenshare is called while it's not on");
      });
    }
    ...
    onJoin(e) {
      ...
      this.audioPlaylist = new Ft(t2, "audio", this.syncPlaylistState.bind(this), this.store), this.videoPlaylist = new Ft(t2, "video", this.syncRoomState.bind(this), this.store), this.syncRoomState("joinSync"), this.setState((i2) => {
        var r2;
    ...
    onPeerUpdate(e, t2) {
      if (![4, 5].includes(e)) {
        if (Array.isArray(t2)) {
          ...
          if (this.syncRoomState("peersJoined"), this.store.getState(Fe)) {
            let o2 = [];
            for (let n2 of t2) {
              let d2 = this.store.getState(re(n2.peerId));
              d2 && o2.push(d2);
            }
            this.hmsNotifications.sendPeerList(o2);
          } else r2.forEach((o2) => {
            let n2 = this.store.getState(re(o2.peerId));
    ...
    onTrackUpdate(e, t2, i2) {
      if (e === 1) this.hmsNotifications.sendTrackUpdate(e, t2.trackId), this.handleTrackRemove(t2, i2);
        ...
        let r2 = Bt[e] || "trackUpdate", s2 = _2.convertTrack(t2);
        this.setState((o2) => {
          let n2 = o2.tracks[s2.id];
          Je(n2, s2) && (ls(n2, s2), Object.assign(n2, s2));
        }, r2), this.hmsNotifications.sendTrackUpdate(e, t2.trackId);
      }
    }
    onMessageReceived(e) {
      let t2 = _2.convertMessage(e, this.store.getState(Ae));
    ...
    onChangeTrackStateRequest(e) {
      var s2;
      let t2 = this.store.getState(re((s2 = e.requestedBy) == null ? void 0 : s2.peerId)), i2 = this.getStoreLocalTrackIDfromSDKTrack(e.track), r2 = this.store.getState(Li(i2));
    ...
    onChangeMultiTrackStateRequest(e) {
      var s2;
      let t2 = this.store.getState(re((s2 = e.requestedBy) == null ? void 0 : s2.peerId));
    ...
    getMediaSettings(e) {
      var s2;
      let t2 = this.store.getState(ba), i2 = e.audioTrack, r2 = e.videoTrack;
    ...
    setTrackVolume(e, t2) {
      return c2(this, null, function* () {
        ...
        i2 ? i2 instanceof Ne ? (yield i2.setVolume(e), this.setState((r2) => {
          let s2 = r2.tracks[t2];
    ...
    localAndVideoUnmuting(e) {
      let t2 = this.store.getState(ne);
      if ((t2 == null ? void 0 : t2.videoTrack) !== e) return false;
      let i2 = this.store.getState(Aa), r2 = this.store.getState(rs);
      return i2 && !r2;
    }
  ...
  var Ki = (a10) => B2 ? `${a10} ${document.title}` : a10;
  var qi = class {
    constructor(e, t2) {
      this.eventBus = e;
      this.listener = t2;
      ...
      this.start = (e2) => c2(this, null, function* () {
        var u2;
        if (!e2) return;
        let { url: t3, timeout: i2, scoreMap: r2 } = e2, s2 = this.controller.signal, o2 = Date.now(), n2 = 0, d2 = X2(i2).then(() => {
  ...
  var Wt = class {
    constructor(e, t2, i2, r2, s2, o2) {
      ...
      this.diffRolesAndPublishTracks = (i3) => c2(this, [i3], function* ({ oldRole: e2, newRole: t3 }) {
        var g2, f2, P2, v2, A2, W2;
        let r3 = new Set(e2.publishParams.allowed), s3 = new Set(t3.publishParams.allowed), o3 = this.removeTrack(r3, s3, "video"), n2 = this.removeTrack(r3, s3, "audio"), d2 = this.removeTrack(r3, s3, "screen"), u2 = this.hasSimulcastDifference((g2 = e2.publishParams.simulcast) == null ? void 0 : g2.video, (f2 = t3.publishParams.simulcast) == null ? void 0 : f2.video), p2 = this.hasSimulcastDifference((P2 = e2.publishParams.simulcast) == null ? void 0 : P2.screen, (v2 = t3.publishParams.simulcast) == null ? void 0 : v2.screen), h2 = (W2 = (A2 = this.store.getLocalPeer()) == null ? void 0 : A2.videoTrack) == null ? void 0 : W2.enabled;
  ...
  var ps = class {
    ...
    sendEvent(e) {
      ...
      let t2 = { event: e.name, payload: e.properties, event_id: String(e.timestamp), peer: e.metadata.peer, timestamp: e.timestamp, device_id: e.device_id, cluster: { websocket_url: this.websocketURL } }, i2 = this.env === "prod" ? la : ua;
  ...
  var $t = class {
    constructor(e) {
      this.type = e.type, this.source = e.source || "regular", this.description = "", e instanceof _e ? (this.mute = !e.enabled, this.track_id = e.publishedTrackId, this.stream_id = e.stream.id) : (this.mute = e.mute, this.track_id = e.track_id, this.stream_id = e.stream_id);
    }
  };
  var Kt = class {
    constructor() {
    ...
    removeRemoteTracks() {
      this.tracks.forEach((e) => {
        (e instanceof oe || e instanceof x2) && (this.removeTrack(e), delete this.peerTrackStates[e.trackId]);
      });
    }
    getEnv() {
      return this.env;
    ...
    getRemoteVideoTracks() {
      return this.getTracks().filter((e) => e instanceof x2);
    }
    getAudioTracks() {
    ...
    setConfig(e) {
      var t2, i2, r2;
      if (te.rememberDevices(!!e.rememberDeviceSelection), e.rememberDeviceSelection) {
        let s2 = te.getSelection();
    ...
    updateAudioOutputDevice(e) {
      return c2(this, null, function* () {
        ...
        this.getAudioTracks().forEach((i2) => {
          i2 instanceof oe && t2.push(i2.setOutputDevice(e));
    ...
    getSimulcastDefinitionsForPeer(e, t2) {
      ...
      return t2 === "regular" ? (r2 = (n2 = i2.simulcast) == null ? void 0 : n2.video, s2 = i2.video.width, o2 = i2.video.height) : t2 === "screen" && (r2 = (d2 = i2.simulcast) == null ? void 0 : d2.screen, s2 = i2.screen.width, o2 = i2.screen.height), ((u2 = r2 == null ? void 0 : r2.layers) == null ? void 0 : u2.map((p2) => {
        let h2 = Ke[p2.rid], T = { width: Math.floor(s2 / p2.scaleResolutionDownBy), height: Math.floor(o2 / p2.scaleResolutionDownBy) };
  ...
  var lo = { autoplayFailed: void 0, initialized: false, autoplayCheckPromise: void 0 };
  var qt = class {
    constructor(e, t2, i2) {
      this.store = e;
      ...
      this.handleTrackAdd = (r2) => c2(this, [r2], function* ({ track: e2, peer: t3, callListener: i3 = true }) {
        ...
        s2.style.display = "none", s2.id = e2.trackId, s2.addEventListener("pause", this.handleAudioPaused), s2.onerror = () => c2(this, null, function* () {
          ...
          this.eventBus.analytics.publish(y2.audioPlaybackError(d2)), ((p2 = s2 == null ? void 0 : s2.error) == null ? void 0 : p2.code) === MediaError.MEDIA_ERR_DECODE && (this.removeAudioElement(s2, e2), yield X2(500), yield this.handleTrackAdd({ track: e2, peer: t3, callListener: false }), this.state.autoplayFailed || this.eventBus.analytics.publish(y2.audioRecovered("Audio recovered after media decode error")));
    ...
    unblockAutoplay() {
      return c2(this, null, function* () {
        this.autoPausedTracks.size > 0 && (yield this.unpauseAudioTracks()), yield pe.resumeContext();
      });
    }
    init(e) {
    ...
    cleanup() {
      var e;
      (e = this.audioSink) == null || e.remove(), this.audioSink = void 0, this.eventBus.audioTrackAdded.unsubscribe(this.handleTrackAdd), this.eventBus.audioTrackRemoved.unsubscribe(this.handleTrackRemove), this.eventBus.audioTrackUpdate.unsubscribe(this.handleTrackUpdate), this.eventBus.deviceChange.unsubscribe(this.handleAudioDeviceChange), this.eventBus.localVideoUnmutedNatively.unsubscribe(this.unpauseAudioTracks), this.eventBus.localAudioUnmutedNatively.unsubscribe(this.unpauseAudioTracks), this.autoPausedTracks = /* @__PURE__ */ new Set(), this.state = m({}, lo);
    }
    playAudioFor(e) {
      return c2(this, null, function* () {
  ...
  var jt = class {
    constructor(e, t2) {
      ...
      this.updateOutputDevice = (e2, t3) => c2(this, null, function* () {
        ...
        return i3 && (this.outputDevice = i3, yield this.store.updateAudioOutputDevice(i3), this.eventBus.analytics.publish(y2.deviceChange({ isUserSelection: t3, selection: { audioOutput: i3 }, devices: this.getDevices(), type: "audioOutput" })), te.updateSelection("audioOutput", { deviceId: i3.deviceId, groupId: i3.groupId })), i3;
      });
      ...
      this.enumerateDevices = () => c2(this, null, function* () {
        try {
          ...
          }), this.videoInputChanged = this.computeChange(t3, this.videoInput), this.audioInputChanged = this.computeChange(i3, this.audioInput), te.setDevices({ videoInput: [...this.videoInput], audioInput: [...this.audioInput], audioOutput: [...this.audioOutput] }), this.logDevices("Enumerate Devices");
        } catch (e2) {
      ...
      this.updateToActualDefaultDevice = () => c2(this, null, function* () {
        ...
        if (!((s2 = (r2 = this.store.getConfig()) == null ? void 0 : r2.settings) == null ? void 0 : s2.videoDeviceId) && (e2 != null && e2.videoTrack) && (yield e2.videoTrack.setSettings({ deviceId: (o2 = this.videoInput[0]) == null ? void 0 : o2.deviceId }, true)), !((d2 = (n2 = this.store.getConfig()) == null ? void 0 : n2.settings) == null ? void 0 : d2.audioInputDeviceId) && (e2 != null && e2.audioTrack)) {
          let u2 = () => {
            ...
            return xs() && h2 ? h2 == null ? void 0 : h2.deviceId : (T = this.getNewAudioInputDevice()) == null ? void 0 : T.deviceId;
          };
          u2() && (yield e2.audioTrack.setSettings({ deviceId: u2() }, true));
        }
      });
      this.handleDeviceChange = vi(() => c2(this, null, function* () {
      ...
      this.handleAudioInputDeviceChange = (e2) => c2(this, null, function* () {
        ...
        if (!t3 || !t3.deviceId) {
          this.eventBus.analytics.publish(y2.deviceChange({ selection: { audioInput: t3 }, error: S2.TracksErrors.SelectedDeviceMissing("audio"), devices: this.getDevices(), type: "audioInput" })), l2.e(this.TAG, "Audio device not found"), this.eventBus.deviceChange.publish({ error: S2.TracksErrors.SelectedDeviceMissing("audio"), selection: t3, type: "audioInput", devices: this.getDevices() });
          return;
        }
        let { settings: i3 } = e2, r2 = new Y2().codec(i3.codec).maxBitrate(i3.maxBitrate).deviceId(t3.deviceId).audioMode(i3.audioMode).build();
        try {
      ...
      this.handleVideoInputDeviceChange = (e2) => c2(this, null, function* () {
        ...
        if (!t3 || !t3.deviceId) {
          this.eventBus.analytics.publish(y2.deviceChange({ selection: { videoInput: t3 }, error: S2.TracksErrors.SelectedDeviceMissing("video"), devices: this.getDevices(), type: "video" })), l2.e(this.TAG, "Video device not found"), this.eventBus.deviceChange.publish({ error: S2.TracksErrors.SelectedDeviceMissing("video"), selection: t3, type: "video", devices: this.getDevices() });
          return;
        }
        let { settings: i3 } = e2, r2 = new J().codec(i3.codec).maxBitrate(i3.maxBitrate).maxFramerate(i3.maxFramerate).setWidth(i3.width).setHeight(i3.height).deviceId(t3.deviceId).build();
        try {
      ...
      this.autoSelectAudioOutput = (e2) => c2(this, null, function* () {
        ...
        if (!(!e2 && o2.settings.deviceId === d2 && this.earpieceSelected)) try {
          (!this.earpieceSelected || e2) && ((t3 == null ? void 0 : t3.deviceId) === d2 ? this.earpieceSelected = true : (l2.d(this.TAG, "selecting earpiece"), yield o2.setSettings({ deviceId: i3 == null ? void 0 : i3.deviceId }, true), e2 && (yield X2(e2)), this.earpieceSelected = true)), yield o2.setSettings({ deviceId: d2 }, true);
    ...
    getAudioOutputDeviceMatchingInput(e) {
      ...
      if (r2) return r2;
      let s2 = this.audioOutput.find((d2) => d2.groupId === e.groupId && d2.deviceId !== "default");
      if (s2) return s2;
    }
    logDevices(e = "") {
  ...
  var Jt = class {
    constructor() {
      ...
      this.analytics = new V(F.ANALYTICS, this.eventEmitter);
      this.deviceChange = new V(F.DEVICE_CHANGE, this.eventEmitter);
      this.localAudioEnabled = new V(F.LOCAL_AUDIO_ENABLED, this.eventEmitter);
      this.localVideoEnabled = new V(F.LOCAL_VIDEO_ENABLED, this.eventEmitter);
      this.localVideoUnmutedNatively = new V(F.LOCAL_VIDEO_UNMUTED_NATIVELY, this.eventEmitter);
      this.localAudioUnmutedNatively = new V(F.LOCAL_AUDIO_UNMUTED_NATIVELY, this.eventEmitter);
      this.statsUpdate = new V(F.STATS_UPDATE, this.eventEmitter);
      this.trackDegraded = new V(F.TRACK_DEGRADED, this.eventEmitter);
      this.trackRestored = new V(F.TRACK_RESTORED, this.eventEmitter);
      this.trackAudioLevelUpdate = new V(F.TRACK_AUDIO_LEVEL_UPDATE, this.eventEmitter);
      this.audioPluginFailed = new V(F.AUDIO_PLUGIN_FAILED, this.eventEmitter);
      this.localAudioSilence = new V(F.LOCAL_AUDIO_SILENCE, this.eventEmitter);
      this.policyChange = new V(F.POLICY_CHANGE, this.eventEmitter);
      this.localRoleUpdate = new V(F.LOCAL_ROLE_UPDATE, this.eventEmitter);
      this.audioTrackUpdate = new V(F.AUDIO_TRACK_UPDATE, this.eventEmitter);
      this.audioTrackAdded = new V(F.AUDIO_TRACK_ADDED, this.eventEmitter);
      this.audioTrackRemoved = new V(F.AUDIO_TRACK_REMOVED, this.eventEmitter);
      this.autoplayError = new V(F.AUTOPLAY_ERROR, this.eventEmitter);
      this.leave = new V(F.LEAVE, this.eventEmitter);
      this.error = new V(F.ERROR, this.eventEmitter);
    }
  };
  var Yi = class {
    constructor(e, t2, i2) {
    ...
    constructor(e, t2, i2) {
      ...
      this.handleTrackLayerUpdate = (e2) => {
        for (let t3 in e2.tracks) {
          ...
          !r2 || !this.store.getPeerByTrackId(t3) || r2 instanceof x2 && this.setLayer(r2, i3);
        }
      };
  ...
  var er = class extends pt {
    constructor(t2, i2, r2, s2) {
      ...
      this.processTrackInfo = (t3, i3, r3 = true) => {
        ...
        let o2 = new be(new MediaStream(), this.transport.getSubscribeConnection()), n2 = Te.getEmptyVideoTrack();
        n2.enabled = !t3.mute;
        let d2 = new x2(o2, n2, t3.source, (u2 = this.store.getRoom()) == null ? void 0 : u2.disableNoneLayerRequest);
  ...
  var ir = class {
    ...
    handlePeerUpdate(e) {
      ...
      let r2 = (d2 = e.groups) == null ? void 0 : d2.includes(Ie);
  ...
  var hs = ((f2) => (f2.FLAG_SERVER_SUB_DEGRADATION = "subscribeDegradation", f2.FLAG_SERVER_SIMULCAST = "simulcast", f2.FLAG_NON_WEBRTC_DISABLE_OFFER = "nonWebRTCDisableOffer", f2.FLAG_PUBLISH_STATS = "publishStats", f2.FLAG_SUBSCRIBE_STATS = "subscribeStats", f2.FLAG_ON_DEMAND_TRACKS = "onDemandTracks", f2.FLAG_DISABLE_VIDEO_TRACK_AUTO_UNSUBSCRIBE = "disableVideoTrackAutoUnsubscribe", f2.FLAG_WHITEBOARD_ENABLED = "whiteboardEnabled", f2.FLAG_EFFECTS_SDK_ENABLED = "effectsSDKEnabled", f2.FLAG_VB_ENABLED = "vb", f2.FLAG_HIPAA_ENABLED = "hipaa", f2.FLAG_NOISE_CANCELLATION = "noiseCancellation", f2.FLAG_SCALE_SCREENSHARE_BASED_ON_PIXELS = "scaleScreenshareBasedOnPixels", f2.FLAG_DISABLE_NONE_LAYER_REQUEST = "disableNoneLayerRequest", f2))(hs || {});
  var zt = (a10, e, t2) => {
    let i2 = t2 === "qa" ? Sa : ma, r2 = new URL(i2);
  ...
  var sr = class {
    ...
    open(e) {
      return c2(this, null, function* () {
        ...
        let r2 = yield this.transport.signal.getWhiteboard({ id: i2 }), s2 = M2(m({}, t2), { title: e == null ? void 0 : e.title, attributes: e == null ? void 0 : e.attributes, id: r2.id, url: zt(r2.token, r2.addr, this.store.getEnv()), token: r2.token, addr: r2.addr, owner: r2.owner, permissions: r2.permissions || [], open: true });
  ...
  var Yt = class {
    constructor(e, t2, i2) {
      ...
      this.store = t2;
      this.listener = i2;
      this.whiteboard = new sr(e, t2, i2);
    }
    setListener(e) {
    ...
    createPoll(e) {
      return c2(this, null, function* () {
        ...
        let r2 = yield this.transport.signal.getPollQuestions({ poll_id: e.id, index: 0, count: 50 }), s2 = ar(M2(m({}, e), { poll_id: e.id, state: "created", created_by: (o2 = this.store.getLocalPeer()) == null ? void 0 : o2.peerId }));
    ...
    getPolls() {
      return c2(this, null, function* () {
        ...
        for (let d2 of r2) {
          let u2 = yield this.transport.signal.getPollQuestions({ poll_id: d2.poll_id, index: 0, count: 50 }), p2 = ar(d2), h2 = this.store.getPoll(d2.poll_id);
          p2.questions = u2.questions.map(({ question: T, options: g2, answer: f2 }, P2) => {
            var v2, A2;
            return M2(m({}, T), { options: g2, answer: f2, responses: (A2 = (v2 = h2 == null ? void 0 : h2.questions) == null ? void 0 : v2[P2]) == null ? void 0 : A2.responses });
    ...
    handlePollStart(e) {
      return c2(this, null, function* () {
        ...
        for (let s2 of e.polls) {
          ...
          let n2 = yield this.transport.signal.getPollQuestions({ poll_id: s2.poll_id, index: 0, count: 50 }), d2 = ar(s2);
    ...
    handleWhiteboardUpdate(e) {
      return c2(this, null, function* () {
        ...
        if (o2.open = r2 ? i2 == null ? void 0 : i2.open : s2, o2.owner = o2.open ? e.owner : void 0, o2.open) if (r2) o2.url = i2 == null ? void 0 : i2.url, o2.token = i2 == null ? void 0 : i2.token, o2.addr = i2 == null ? void 0 : i2.addr, o2.permissions = i2 == null ? void 0 : i2.permissions;
          ...
          o2.url = zt(d2.token, d2.addr, this.store.getEnv()), o2.token = d2.token, o2.addr = d2.addr, o2.permissions = d2.permissions, o2.open = d2.permissions.length > 0;
        }
  ...
  var ur = class {
    constructor(e, t2, i2, r2, s2, o2) {
      ...
      this.trackManager = n2 ? new er(this.store, t2, this.transport, this.listener) : new pt(this.store, t2, this.listener), this.peerManager = new ir(this.store, this.trackManager, this.listener), this.peerListManager = new tr(this.store, this.peerManager, this.trackManager, this.listener), this.broadcastManager = new Xi(this.listener), this.policyChangeManager = new rr(this.store, t2), this.requestManager = new nr(this.store, this.listener), this.activeSpeakerManager = new Yi(this.store, this.listener, this.audioListener), this.connectionQualityManager = new Zi(this.store, this.connectionQualityListener), this.roomUpdateManager = new cr(this.store, this.listener), this.sessionMetadataManager = new dr(this.store, this.listener), this.pollsManager = new or(this.store, this.transport, this.listener), this.whiteboardManager = new lr(this.store, this.transport, this.listener);
    }
    setListener(e) {
  ...
  var z2 = ((s2) => (s2[s2.ConnectFailed = 0] = "ConnectFailed", s2[s2.SignalDisconnect = 1] = "SignalDisconnect", s2[s2.JoinWSMessageFailed = 2] = "JoinWSMessageFailed", s2[s2.PublishIceConnectionFailed = 3] = "PublishIceConnectionFailed", s2[s2.SubscribeIceConnectionFailed = 4] = "SubscribeIceConnectionFailed", s2))(z2 || {});
  var uo = { 0: [], 1: [], 2: [1], 3: [1], 4: [1] };
  var mr = ((n2) => (n2.Disconnected = "Disconnected", n2.Connecting = "Connecting", n2.Joined = "Joined", n2.Preview = "Preview", n2.Failed = "Failed", n2.Reconnecting = "Reconnecting", n2.Leaving = "Leaving", n2))(mr || {});
  var Sr = class {
    constructor(e) {
  ...
  var gr = class {
    ...
    scheduleTask(u2) {
      return c2(this, arguments, function* ({ category: e, error: t2, changeState: i2, task: r2, originalState: s2, failedAt: o2, maxRetryTime: n2 = 6e4, failedRetryCount: d2 = 0 }) {
        if (l2.d(this.TAG, "schedule: ", { category: z2[e], error: t2 }), d2 === 0) {
          let v2 = this.inProgress.get(e);
          if (v2) {
            l2.d(this.TAG, `schedule: Already a task for ${z2[e]} scheduled, waiting for its completion`), yield v2.promise;
            return;
          }
          let A2 = new Sr((W2, se) => {
          });
          this.inProgress.set(e, A2), this.sendEvent(t2, e);
        }
        let p2 = false, h2 = uo[e];
        for (let v2 in h2) {
          let A2 = h2[parseInt(v2)];
          try {
            let W2 = this.inProgress.get(A2);
            W2 && (l2.d(this.TAG, `schedule: Suspending retry task of ${z2[e]}, waiting for ${z2[A2]} to recover`), yield W2.promise, l2.d(this.TAG, `schedule: Resuming retry task ${z2[e]} as it's dependency ${z2[A2]} is recovered`));
          } catch (W2) {
            l2.d(this.TAG, `schedule: Stopping retry task of ${z2[e]} as it's dependency ${z2[A2]} failed to recover`), p2 = true;
            break;
          }
        }
        let T = (v2) => {
        ...
        if (g2 >= n2 || p2) return t2.description += `. [${z2[e]}] Could not recover after ${g2} milliseconds`, p2 && (t2.description += ` Could not recover all of it's required dependencies - [${h2.map((v2) => z2[v2]).toString()}]`), t2.isTerminal = true, T(t2);
        i2 && this.onStateChange("Reconnecting", t2);
        let f2 = this.getDelayForRetryCount(e);
        l2.d(this.TAG, `schedule: [${z2[e]}] [failedRetryCount=${d2}] Scheduling retry task in ${f2}ms`);
        let P2;
        try {
          ...
          P2 = false;
          let A2 = v2;
          if (A2.isTerminal) return l2.e(this.TAG, `[${z2[e]}] Un-caught terminal exception ${A2.name} in retry-task`, v2), T(A2);
          l2.w(this.TAG, `[${z2[e]}] Un-caught exception ${A2.name} in retry-task, initiating retry`, v2);
        }
        if (P2) {
          let v2 = this.inProgress.get(e);
          this.inProgress.delete(e), v2 == null || v2.resolve(d2), i2 && this.inProgress.size === 0 && this.onStateChange(s2), l2.d(this.TAG, `schedule: [${z2[e]}] [failedRetryCount=${d2}] Recovered \u267B\uFE0F after ${g2}ms`);
  ...
  var ht = class {
    ...
    startLoop() {
      return c2(this, null, function* () {
        for (; this.shouldSendEvent; ) yield X2(this.pushInterval * 1e3), this.sendEvent();
      });
    }
    sendEvent() {
  ...
  var mt = class {
    ...
    calculateAverage(e, t2 = true) {
      ...
      return r2 !== void 0 ? t2 ? Math.round(r2) : r2 : void 0;
    }
  ...
  var Mr = (a10, e) => a10 && e && (a10.frameWidth !== e.frameWidth || a10.frameHeight !== e.frameHeight);
  var yr = (a10, e) => a10 && e && a10.enabled !== e.enabled;
  var Xt = (a10) => Object.entries(a10).filter(([, e]) => e !== void 0).reduce((e, [t2, i2]) => (e[t2] = i2, e), {});
  var kr = class {
    constructor() {
      this.worstState = void 0;
      this.TAG = "[CPUPressureMonitor]";
      this.stateRanking = { nominal: 0, fair: 1, serious: 2, critical: 3 };
      this.init();
    }
    init() {
      return c2(this, null, function* () {
        if (!("PressureObserver" in window)) {
          l2.d(this.TAG, "PressureObserver API not available");
          return;
        }
        try {
          this.observer = new PressureObserver((e) => {
            if (e.length > 0) {
              let t2 = e[e.length - 1].state;
              this.updateWorstState(t2);
            }
          }), yield this.observer.observe("cpu", { sampleInterval: 1e4 }), this.worstState = "nominal", l2.d(this.TAG, "CPU pressure monitoring started");
        } catch (e) {
          l2.e(this.TAG, "Failed to initialize CPU pressure monitoring", e);
        }
      });
    }
    updateWorstState(e) {
      ...
      this.stateRanking[e] > this.stateRanking[this.worstState] && (this.worstState = e, l2.d(this.TAG, `New worst CPU state: ${this.worstState}`));
    }
    getWorstState() {
      return this.worstState;
    }
    resetWorstState() {
      this.worstState !== void 0 && (this.worstState = "nominal", l2.d(this.TAG, "CPU worst state reset to nominal"));
    }
    stop() {
      if (this.observer) try {
        this.observer.disconnect(), l2.d(this.TAG, "CPU pressure monitoring stopped");
      } catch (e) {
        l2.e(this.TAG, "Error stopping CPU pressure monitoring", e);
      }
    }
  };
  var Zt = class extends ht {
    constructor(t2, i2, r2, s2) {
      ...
      this.cpuPressureMonitor = new kr();
    }
    toAnalytics() {
      var r2, s2;
      let t2 = [], i2 = [];
    ...
    stop() {
      var t2;
      super.stop(), (t2 = this.cpuPressureMonitor) == null || t2.stop();
    }
      ...
      Object.keys(r2).forEach((s2) => {
        ...
        Object.keys(o2).forEach((d2) => {
          ...
          if (p2 && this.trackAnalytics.has(p2)) (P2 = this.trackAnalytics.get(p2)) == null || P2.pushTempStat(h2);
            ...
            let v2 = new ms({ track: n2, sampleWindowSize: this.sampleWindowSize, rid: u2.rid, ssrc: u2.ssrc.toString(), kind: u2.kind, cpuPressureMonitor: this.cpuPressureMonitor });
  ...
  var ms = class extends mt {
    constructor(t2) {
      super(t2);
      this.samples = [];
      this.getQualityLimitation = (t3) => {
        let i2 = t3.qualityLimitationDurations;
        return i2 && { bandwidth_sec: i2.bandwidth, cpu_sec: i2.cpu, other_sec: i2.other };
      };
      this.getSourceStats = (t3) => {
        if (!t3.sourceStatsAvailable) return {};
        let i2 = t3.sourceFrameHeight ? { height_px: t3.sourceFrameHeight, width_px: t3.sourceFrameWidth } : void 0, r2 = this.calculateDifferenceForSample("sourceFrames"), s2 = this.calculateDifferenceForSample("framesEncoded"), o2 = r2 && s2 ? Math.max(0, r2 - s2) : void 0;
        return { source_resolution: i2, source_avg_fps: this.calculateAverage("sourceFramesPerSecond"), source_total_frames: r2, source_total_frames_dropped: o2 };
      };
      this.collateSample = () => {
        var p2, h2, T, g2, f2, P2;
        let t3 = this.getFirstStat(), i2 = this.getLatestStat(), r2 = i2.frameHeight ? { height_px: i2.frameHeight, width_px: i2.frameWidth } : void 0, s2 = this.calculateAverage("jitter", false), o2 = this.calculateAverage("roundTripTime", false), n2 = (p2 = this.cpuPressureMonitor) == null ? void 0 : p2.getWorstState();
        (h2 = this.cpuPressureMonitor) == null || h2.resetWorstState();
        let d2 = (g2 = (T = this.track).getMediaTrackSettings) == null ? void 0 : g2.call(T), u2 = (P2 = (f2 = this.track).getPluginsMetrics) == null ? void 0 : P2.call(f2);
        return Xt(m({ timestamp: Date.now(), sample_start_ts: t3.timestamp, sample_end_ts: i2.timestamp, sample_duration_ms: i2.timestamp - t3.timestamp, avg_available_outgoing_bitrate_bps: this.calculateAverage("availableOutgoingBitrate"), avg_bitrate_bps: this.calculateAverage("bitrate"), avg_fps: this.calculateAverage("framesPerSecond"), total_packets_lost: i2.packetsLost, total_packets_sent: i2.packetsSent, total_packet_sent_delay_sec: parseFloat(this.calculateDifferenceForSample("totalPacketSendDelay").toFixed(4)), total_fir_count: this.calculateDifferenceForSample("firCount"), total_pli_count: this.calculateDifferenceForSample("pliCount"), total_nack_count: this.calculateDifferenceForSample("nackCount"), avg_jitter_ms: s2 ? Math.round(s2 * 1e3) : void 0, avg_round_trip_time_ms: o2 ? Math.round(o2 * 1e3) : void 0, total_quality_limitation: this.getQualityLimitation(i2), resolution: r2, cpu_pressure_state: n2, track_settings: d2, effects_metrics: u2 && Object.keys(u2).length > 0 ? u2 : void 0 }, this.getSourceStats(i2)));
      };
      this.shouldCreateSample = () => {
        let t3 = this.tempStats.length, i2 = this.tempStats[t3 - 1], r2 = this.tempStats[t3 - 2];
        return t3 === 30 || yr(i2, r2) || i2.kind === "video" && Mr(i2, r2);
      };
      this.toAnalytics = () => ({ track_id: this.track_id, ssrc: this.ssrc, source: this.source, rid: this.rid, samples: this.samples });
      this.cpuPressureMonitor = t2.cpuPressureMonitor;
    }
  };
  var ei = class extends ht {
    ...
    handleStatsUpdate(t2) {
      ...
      Object.keys(i2).forEach((s2) => {
        var f2, P2;
        let o2 = this.store.getTrackById(s2), n2 = i2[s2], d2 = (f2 = this.trackAnalytics.get(s2)) == null ? void 0 : f2.getLatestStat(), p2 = ((v2, A2) => {
          let W2 = (A2 == null ? void 0 : A2.jitterBufferDelay) || 0, se = (A2 == null ? void 0 : A2.jitterBufferEmittedCount) || 0, U2 = ((v2 == null ? void 0 : v2.jitterBufferDelay) || 0) - W2, ae = ((v2 == null ? void 0 : v2.jitterBufferEmittedCount) || 0) - se;
          return ae > 0 ? U2 * 1e3 / ae : (A2 == null ? void 0 : A2.calculatedJitterBufferDelay) || 0;
        ...
        if (this.trackAnalytics.has(s2)) (P2 = this.trackAnalytics.get(s2)) == null || P2.pushTempStat(T);
          ...
          let v2 = new gs({ track: o2, sampleWindowSize: this.sampleWindowSize, ssrc: n2.ssrc.toString(), kind: n2.kind });
    ...
    calculateAvSyncForStat(t2, i2) {
      ...
      if (!(s2 && o2 && s2.enabled && o2.enabled)) return Dt;
  ...
  function po(a10, e) {
    ...
    }), { type: a10.type, sdp: ti.write(t2) };
  }
  function ho(a10, e) {
    var s2;
    if (!(a10 != null && a10.sdp) || !e) return;
    let i2 = ti.parse(a10.sdp).media.find((o2) => $(o2.mid) && parseInt(o2.mid) === parseInt(e));
  ...
  var Ye = class {
    ...
    createOffer(e, t2) {
      return c2(this, null, function* () {
        try {
          ...
          return l2.d(Ce, `[role=${this.role}] createOffer offer=${JSON.stringify(i2, null, 1)}`), mo(po(i2, e));
        } catch (i2) {
        ...
        (this.role === 0 ? this.getSenders() : this.getReceivers()).forEach((t2) => {
          ...
          if (t2.transport) {
            let s2 = t2.transport.iceTransport, o2 = () => {
              typeof s2.getSelectedCandidatePair == "function" && (this.selectedCandidatePair = s2.getSelectedCandidatePair(), this.selectedCandidatePair && (this.observer.onSelectedCandidatePairChange(this.selectedCandidatePair), l2.d(Ce, `${St[this.role]} connection`, `selected ${i2 || "unknown"} candidate pair`, JSON.stringify(this.selectedCandidatePair, null, 2))));
            };
            typeof s2.onselectedcandidatepairchange == "function" && (s2.onselectedcandidatepairchange = o2), o2();
          }
        });
      } catch (e) {
        l2.w(Ce, `Error in logging selected ice candidate pair for ${St[this.role]} connection`, e);
      }
    }
    removeTrack(e) {
    ...
    setMaxBitrateAndFramerate(e, t2) {
      return c2(this, null, function* () {
        let i2 = (t2 == null ? void 0 : t2.maxBitrate) || e.settings.maxBitrate, r2 = e instanceof K && e.settings.maxFramerate, s2 = this.getSenders().find((o2) => {
          var n2;
  ...
  var ii = class extends Ye {
    constructor(t2, i2, r2) {
      super(0, t2);
      this.TAG = "[HMSPublishConnection]";
      this.observer = r2, this.nativeConnection = new RTCPeerConnection(i2), this.channel = this.nativeConnection.createDataChannel(ki, { protocol: "SCTP" }), this.channel.onerror = (s2) => l2.e(this.TAG, `publish data channel onerror ${s2}`, s2), this.nativeConnection.onicecandidate = ({ candidate: s2 }) => {
  ...
  var si = class extends Ye {
    ...
    initNativeConnectionCallbacks() {
      this.nativeConnection.oniceconnectionstatechange = () => {
        ...
        t2.channel.label === ki && (this.apiChannel = new ri(t2.channel, { onMessage: (i2) => {
        ...
        let s2 = this.remoteStreams.get(r2), o2 = t2.track.kind === "audio", n2 = o2 ? oe : x2, d2 = o2 ? new n2(s2, t2.track) : new n2(s2, t2.track, void 0, this.isFlagEnabled("disableNoneLayerRequest"));
        t2.track.kind === "video" && s2.setVideoLayerLocally("none", "addTrack", "subscribeConnection"), d2.transceiver = t2.transceiver;
        let u2 = ho(this.remoteDescription, (p2 = t2.transceiver) == null ? void 0 : p2.mid);
  ...
  var So = (a10, e) => !e || e.length === 0 ? a10 : e.map((i2) => ({ urls: i2.urls, credentialType: "password", credential: i2.password, username: i2.userName }));
  var Pr = "[InitService]";
  var ai = class {
    ...
    static fetchInitConfig(n2) {
      return c2(this, arguments, function* ({ token: e, peerId: t2, userAgent: i2, initEndpoint: r2 = "https://prod-init.100ms.live", region: s2 = "", iceServers: o2 }) {
        l2.d(Pr, `fetchInitConfig: initEndpoint=${r2} token=${e} peerId=${t2} region=${s2} `);
        let d2 = qn(r2, t2, i2, s2);
        try {
          let u2 = yield fetch(d2, { headers: { Authorization: `Bearer ${e}` } });
          let _txt;
          try {
            _txt = yield u2.text();
            let p2 = JSON.parse(_txt);
            return this.handleError(u2, p2), l2.d(Pr, `config is ${JSON.stringify(p2, null, 2)}`), jn(p2, o2);
          } catch (p2) {
            throw l2.e(Pr, "json error", p2.message, _txt), p2 instanceof E2 ? p2 : S2.APIErrors.ServerErrors(u2.status, "INIT", p2.message);
          }
        } catch (u2) {
          let p2 = u2;
  ...
  function qn(a10, e, t2, i2) {
    try {
      ...
      let s2 = r2;
      throw l2.e(Pr, s2.name, s2.message), s2;
    }
  }
  function jn(a10, e) {
    var t2;
    return M2(m({}, a10), { rtcConfiguration: M2(m({}, a10.rtcConfiguration), { iceServers: So((t2 = a10.rtcConfiguration) == null ? void 0 : t2.ice_servers, e) }) });
  }
  var oi = class {
    constructor(e) {
      this.TAG = "[SIGNAL]: ";
      this.pongResponseTimes = new Ue(5);
    ...
    internalCall(e, t2) {
      return c2(this, null, function* () {
        ...
        try {
          ...
          let n2 = o2;
          throw S2.WebsocketMethodErrors.ServerErrors(Number(n2.code), Dr(e), n2.message);
        }
      });
    }
    notify(e, t2) {
    ...
    pingPongLoop(e) {
      return c2(this, null, function* () {
        ...
        if (this.isConnected) {
          ...
          this.pongResponseTimes.enqueue(s2), s2 > t2 ? (l2.d(this.TAG, `Pong timeout ${e}, pageHidden=${Os()}`), this.id === e && this.setIsConnected(false, "ping pong failure")) : setTimeout(() => this.pingPongLoop(e), ((r2 = window.HMS) == null ? void 0 : r2.PING_INTERVAL) || 3e3);
        }
      });
    }
    call(e, t2) {
  ...
  var go = () => {
    if (!B2 || typeof navigator.connection == "undefined") return;
  ...
  var ni = class {
    constructor(e, t2, i2, r2, s2, o2, n2) {
      ...
      this.signalObserver = { onOffer: (e2) => c2(this, null, function* () {
        try {
          ...
          if (e2.sfu_node_id && this.subscribeConnection.sfuNodeId && this.subscribeConnection.sfuNodeId !== e2.sfu_node_id) {
            l2.d(R2, "ignoring old offer");
            return;
          }
          yield this.subscribeConnection.setRemoteDescription(e2), l2.d(R2, `[SUBSCRIBE] Adding ${this.subscribeConnection.candidates.length} ice-candidates`, this.subscribeConnection.candidates);
          ...
          yield this.subscribeConnection.setLocalDescription(t3), this.signal.answer(t3), l2.d(R2, "[role=SUBSCRIBE] onOffer renegotiation DONE \u2705");
        } catch (t3) {
          l2.d(R2, "[role=SUBSCRIBE] onOffer renegotiation FAILED \u274C", t3), this.state = "Failed";
          let i3;
        ...
        l2.d(R2, "socket offline", mr[this.state]);
        try {
        ...
        var e2;
        l2.d(R2, "socket online", mr[this.state]), this.analyticsSignalTransport.flushFailedEvents((e2 = this.store.getLocalPeer()) == null ? void 0 : e2.peerId);
      }, onNetworkOnline: () => {
        this.analyticsEventsService.flushFailedClientEvents();
      } };
      this.signal = new oi(this.signalObserver);
      this.analyticsSignalTransport = new vr(this.signal);
      ...
      this.handleLocalRoleUpdate = (i3) => c2(this, [i3], function* ({ oldRole: e2, newRole: t3 }) {
        !this.doesRoleNeedWebRTC(e2) && this.doesRoleNeedWebRTC(t3) && (l2.d(R2, "Local peer role updated to webrtc role, creating PeerConnections and performing inital publish negotiation \u23F3"), this.createPeerConnections(), yield this.negotiateOnFirstPublish());
      });
      this.retryPublishIceFailedTask = () => c2(this, null, function* () {
        if (this.publishConnection) {
          let e2 = new Promise((t3, i3) => {
            this.callbacks.set(at, { promise: { resolve: t3, reject: i3 }, action: "RESTART_ICE", extra: {} });
          });
      ...
      this.retrySubscribeIceFailedTask = () => c2(this, null, function* () {
        if (this.subscribeConnection && this.subscribeConnection.connectionState !== "connected") {
          let e2 = new Promise((i3, r3) => {
            this.callbacks.set(ot, { promise: { resolve: i3, reject: r3 }, action: "RESTART_ICE", extra: {} });
          }), t3 = new Promise((i3) => {
      ...
      this.retrySignalDisconnectTask = () => c2(this, null, function* () {
        var t3;
        l2.d(R2, "retrySignalDisconnectTask", { signalConnected: this.signal.isConnected }), this.signal.isConnected || (yield this.internalConnect(this.joinParameters.authToken, this.joinParameters.endpoint, this.joinParameters.peerId, this.joinParameters.iceServers));
      ...
      this.webrtcInternals = new bi(this.store, this.eventBus);
      let d2 = (u2, p2) => c2(this, null, function* () {
        u2 !== this.state && (this.state = u2, yield this.observer.onStateChange(this.state, p2));
      });
      this.retryScheduler = new gr(d2, this.sendErrorAnalyticsEvent.bind(this)), this.eventBus.statsUpdate.subscribe((u2) => {
        var h2, T;
    ...
    join(e, t2, i2, r2, s2 = false, o2) {
      return c2(this, null, function* () {
        l2.d(R2, "join: started \u23F0");
        try {
          (!this.signal.isConnected || !this.initConfig) && (yield this.connect(e, r2, t2, i2, s2, o2)), this.validateNotDisconnected("connect"), this.initConfig && (yield this.waitForLocalRoleAvailability(), yield this.createConnectionsAndNegotiateJoin(i2, s2), this.initStatsAnalytics(), l2.d(R2, "\u2705 join: Negotiated over PUBLISH connection"));
        } catch (n2) {
          l2.e(R2, `join: failed \u274C [token=${e}]`, n2), this.state = "Failed";
          let d2 = n2;
          throw d2.isTerminal = d2.isTerminal || d2.code === 500, yield this.observer.onStateChange(this.state, d2), d2;
        }
        l2.d(R2, "\u2705 join: successful"), this.state = "Joined", this.observer.onStateChange(this.state);
      });
    }
    connect(e, t2, i2, r2, s2 = false, o2) {
      return c2(this, null, function* () {
        this.setTransportStateForConnect(), this.joinParameters = new hr(e, i2, r2.name, r2.metaData, t2, s2, o2);
        try {
          return yield this.internalConnect(e, t2, i2, o2);
        } catch (n2) {
          if (!(n2 instanceof E2)) throw n2;
          if ([k2.WebSocketConnectionErrors.WEBSOCKET_CONNECTION_LOST, k2.WebSocketConnectionErrors.FAILED_TO_CONNECT, k2.WebSocketConnectionErrors.ABNORMAL_CLOSE].includes(n2.code) || n2.code.toString().startsWith("5") || n2.code.toString().startsWith("429") || n2.code === k2.APIErrors.ENDPOINT_UNREACHABLE && !navigator.onLine) {
    ...
    leave(i2) {
      return c2(this, arguments, function* (e, t2 = "user request") {
        var r2, s2, o2;
        this.retryScheduler.reset(), this.joinParameters = void 0, l2.d(R2, "leaving in transport");
        try {
          ...
          if (n2 && this.eventBus.analytics.publish(y2.getKrispUsage(n2)), this.state = "Leaving", (r2 = this.publishStatsAnalytics) == null || r2.stop(), (s2 = this.subscribeStatsAnalytics) == null || s2.stop(), (o2 = this.webrtcInternals) == null || o2.cleanup(), this.clearPeerConnections(), e) try {
            this.signal.leave(t2), l2.d(R2, "signal leave done");
          } catch (d2) {
            l2.w(R2, "failed to send leave on websocket to server", d2);
          }
          this.analyticsEventsService.flushFailedClientEvents(), this.analyticsEventsService.reset(), yield this.signal.close();
        } catch (n2) {
          this.eventBus.analytics.publish(y2.disconnect(n2)), l2.e(R2, "leave: FAILED \u274C", n2);
        } finally {
    ...
    handleSFUMigration() {
      return c2(this, null, function* () {
        ...
        if (t2.audioTrack) {
          ...
          i2.get(n2.id) || i2.set(n2.id, new fe(new MediaStream()));
        ...
        if (t2.videoTrack) {
          ...
          i2.get(n2.id) || i2.set(n2.id, new fe(new MediaStream())), this.store.removeTrack(t2.videoTrack);
        ...
        for (; t2.auxiliaryTracks.length > 0; ) {
          ...
          if (n2) {
            let d2 = n2.stream;
            i2.get(d2.id) || i2.set(d2.id, new fe(n2.source === "screen" ? d2.nativeStream.clone() : new MediaStream())), this.store.removeTrack(n2);
    ...
    trackUpdate(e, t2) {
      ...
      if (r2) {
        let o2 = new $t(M2(m({}, r2), { mute: !t2 }));
        this.trackStates.set(r2.track_id, o2), l2.d(R2, "Track Update", this.trackStates, e), this.signal.trackUpdate(/* @__PURE__ */ new Map([[r2.track_id, o2]]));
    ...
    publishTrack(e) {
      return c2(this, null, function* () {
        e.publishedTrackId = e.getTrackIDBeingSent(), l2.d(R2, `\u23F3 publishTrack: trackId=${e.trackId}, toPublishTrackId=${e.publishedTrackId}`, `${e}`), this.trackStates.set(e.publishedTrackId, new $t(e));
        let t2 = new Promise((s2, o2) => {
          this.callbacks.set(at, { promise: { resolve: s2, reject: o2 }, action: "PUBLISH", extra: {} });
        }), i2 = e.stream;
        ...
        i2.addTransceiver(e, r2), l2.time(`publish-${e.trackId}-${e.type}`), yield t2, l2.timeEnd(`publish-${e.trackId}-${e.type}`), this.store.addTrack(e), yield i2.setMaxBitrateAndFramerate(e).then(() => {
          l2.d(R2, `Setting maxBitrate=${e.settings.maxBitrate} kpbs${e instanceof K ? ` and maxFramerate=${e.settings.maxFramerate}` : ""} for ${e.source} ${e.type} ${e.trackId}`);
        }).catch((s2) => l2.w(R2, "Failed setting maxBitrate and maxFramerate", s2)), e.isPublished = true, l2.d(R2, `\u2705 publishTrack: trackId=${e.trackId}`, `${e}`, this.callbacks);
      });
    }
    unpublishTrack(e) {
      return c2(this, null, function* () {
        if (l2.d(R2, `\u23F3 unpublishTrack: trackId=${e.trackId}`, `${e}`), e.publishedTrackId && this.trackStates.has(e.publishedTrackId)) this.trackStates.delete(e.publishedTrackId);
        else {
        ...
        let t2 = new Promise((r2, s2) => {
          this.callbacks.set(at, { promise: { resolve: r2, reject: s2 }, action: "UNPUBLISH", extra: {} });
        });
        ...
        }), this.store.removeTrack(e), l2.d(R2, `\u2705 unpublishTrack: trackId=${e.trackId}`, this.callbacks);
      });
    }
    ...
    createPeerConnections() {
      ...
      let e = (s2, o2, n2 = false) => {
        (["disconnected", "failed"].includes(o2) ? l2.w.bind(l2) : l2.d.bind(l2))(R2, `${St[s2]} ${n2 ? "ice" : ""} connection state change: ${o2}`);
      };
      if (this.initConfig) {
        let s2 = { onRenegotiationNeeded: () => c2(this, null, function* () {
          ...
          var p2, h2, T;
          if ((n2 === "failed" ? l2.w.bind(l2) : l2.d.bind(l2))(R2, `Publisher on dtls transport state change: ${n2}`), !n2 || this.lastPublishDtlsState === n2 || (this.lastPublishDtlsState = n2, this.publishDtlsStateTimer !== 0 && (clearTimeout(this.publishDtlsStateTimer), this.publishDtlsStateTimer = 0), n2 !== "connecting" && n2 !== "failed")) return;
          ...
          l2.e(R2, `onDTLSTransportError ${n2.name} ${n2.message}`, n2), this.eventBus.analytics.publish(y2.disconnect(n2));
          ...
          e(0, n2, false), n2 !== "new" && (n2 === "connected" ? ((d2 = this.connectivityListener) == null || d2.onICESuccess(true), (u2 = this.publishConnection) == null || u2.handleSelectedIceCandidatePairs()) : n2 === "failed" ? yield this.handleIceConnectionFailure(0, S2.WebrtcErrors.ICEFailure("PUBLISH", `local candidate - ${(T = (h2 = (p2 = this.publishConnection) == null ? void 0 : p2.selectedCandidatePair) == null ? void 0 : h2.local) == null ? void 0 : T.candidate}; remote candidate - ${(P2 = (f2 = (g2 = this.publishConnection) == null ? void 0 : g2.selectedCandidatePair) == null ? void 0 : f2.remote) == null ? void 0 : P2.candidate}`)) : this.publishDisconnectTimer = window.setTimeout(() => {
            var v2, A2, W2, se, U2, ae, De;
            ((v2 = this.publishConnection) == null ? void 0 : v2.connectionState) !== "connected" && this.handleIceConnectionFailure(0, S2.WebrtcErrors.ICEDisconnected("PUBLISH", `local candidate - ${(se = (W2 = (A2 = this.publishConnection) == null ? void 0 : A2.selectedCandidatePair) == null ? void 0 : W2.local) == null ? void 0 : se.candidate}; remote candidate - ${(De = (ae = (U2 = this.publishConnection) == null ? void 0 : U2.selectedCandidatePair) == null ? void 0 : ae.remote) == null ? void 0 : De.candidate}`));
          }, 5e3));
        }), onIceCandidate: (n2) => {
          var d2;
          ...
          l2.d(R2, "[Subscribe] onTrackAdd", `${n2}`), this.observer.onTrackAdd(n2);
        }, onTrackRemove: (n2) => {
          l2.d(R2, "[Subscribe] onTrackRemove", `${n2}`), this.observer.onTrackRemove(n2);
        }, onIceConnectionChange: (n2) => c2(this, null, function* () {
          var d2;
          if (e(1, n2, true), n2 === "connected") {
            let u2 = this.callbacks.get(ot);
            this.callbacks.delete(ot), (d2 = this.connectivityListener) == null || d2.onICESuccess(false), u2 && u2.promise.resolve(true);
          }
        }), onConnectionStateChange: (n2) => c2(this, null, function* () {
          ...
          if (e(1, n2, false), n2 === "failed") yield this.handleIceConnectionFailure(1, S2.WebrtcErrors.ICEFailure("SUBSCRIBE", `local candidate - ${(p2 = (u2 = (d2 = this.subscribeConnection) == null ? void 0 : d2.selectedCandidatePair) == null ? void 0 : u2.local) == null ? void 0 : p2.candidate}; remote candidate - ${(g2 = (T = (h2 = this.subscribeConnection) == null ? void 0 : h2.selectedCandidatePair) == null ? void 0 : T.remote) == null ? void 0 : g2.candidate}`));
            ...
            var P2, v2, A2, W2, se, U2, ae;
            ((P2 = this.subscribeConnection) == null ? void 0 : P2.connectionState) === "disconnected" && this.handleIceConnectionFailure(1, S2.WebrtcErrors.ICEDisconnected("SUBSCRIBE", `local candidate - ${(W2 = (A2 = (v2 = this.subscribeConnection) == null ? void 0 : v2.selectedCandidatePair) == null ? void 0 : A2.local) == null ? void 0 : W2.candidate}; remote candidate - ${(ae = (U2 = (se = this.subscribeConnection) == null ? void 0 : se.selectedCandidatePair) == null ? void 0 : U2.remote) == null ? void 0 : ae.candidate}`));
          }, 5e3);
          else if (n2 === "connected") {
            (f2 = this.subscribeConnection) == null || f2.handleSelectedIceCandidatePairs();
            let P2 = this.callbacks.get(ot);
            this.callbacks.delete(ot), P2 && P2.promise.resolve(true);
          }
        }), onIceCandidate: (n2) => {
          var d2;
        ...
        this.publishConnection || (this.publishConnection = new ii(this.signal, this.initConfig.rtcConfiguration, s2)), this.subscribeConnection || (this.subscribeConnection = new si(this.signal, this.initConfig.rtcConfiguration, this.isFlagEnabled.bind(this), o2));
      }
    ...
    negotiateJoinWithRetry(s2) {
      return c2(this, arguments, function* ({ name: e, data: t2, autoSubscribeVideo: i2, isWebRTC: r2 = true }) {
        try {
          ...
          l2.e(R2, "Join negotiation failed \u274C", o2);
    ...
    negotiateJoinWebRTC(r2) {
      return c2(this, arguments, function* ({ name: e, data: t2, autoSubscribeVideo: i2 }) {
        if (l2.d(R2, "\u23F3 join: Negotiating over PUBLISH connection"), !this.publishConnection) return l2.e(R2, "Publish peer connection not found, cannot negotiate"), false;
    ...
    negotiateJoinNonWebRTC(r2) {
      return c2(this, arguments, function* ({ name: e, data: t2, autoSubscribeVideo: i2 }) {
        l2.d(R2, "\u23F3 join: Negotiating Non-WebRTC");
    ...
    negotiateOnFirstPublish() {
      return c2(this, null, function* () {
        if (l2.d(R2, "\u23F3 Negotiating offer over PUBLISH connection"), !this.publishConnection) return l2.e(R2, "Publish peer connection not found, cannot negotiate"), false;
        try {
    ...
    performPublishRenegotiation(e) {
      return c2(this, null, function* () {
        l2.d(R2, "\u23F3 [role=PUBLISH] onRenegotiationNeeded START", this.trackStates);
        let t2 = this.callbacks.get(at);
        if (!t2) {
          l2.w(R2, "no callback found for renegotiation");
          return;
        }
        if (!this.publishConnection) {
          l2.e(R2, "Publish peer connection not found, cannot renegotiate");
          return;
        }
        try {
          ...
          this.callbacks.delete(at), l2.timeEnd("renegotiation-offer-exchange"), yield this.publishConnection.setRemoteDescription(r2), t2.promise.resolve(true), l2.d(R2, "[role=PUBLISH] onRenegotiationNeeded DONE \u2705");
        } catch (i2) {
          let r2;
          i2 instanceof E2 ? r2 = i2 : r2 = S2.GenericErrors.Unknown("PUBLISH", i2.message), r2.code === 421 ? t2.promise.resolve(true) : t2.promise.reject(r2), l2.d(R2, "[role=PUBLISH] onRenegotiationNeeded FAILED \u274C");
        }
      });
    }
    ...
    internalConnect(e, t2, i2, r2) {
      return c2(this, null, function* () {
        var o2, n2, d2;
        l2.d(R2, "connect: started \u23F0");
        let s2 = /* @__PURE__ */ new Date();
        try {
          this.analyticsTimer.start("init_response_time"), this.initConfig = yield ai.fetchInitConfig({ token: e, peerId: i2, userAgent: this.store.getUserAgent(), initEndpoint: t2, iceServers: r2 }), (o2 = this.connectivityListener) == null || o2.onInitSuccess(this.initConfig.endpoint);
          let u2 = this.store.getRoom();
          return u2 && (u2.effectsKey = (n2 = this.initConfig.config.vb) == null ? void 0 : n2.effectsKey, u2.isEffectsEnabled = this.isFlagEnabled("effectsSDKEnabled"), u2.disableNoneLayerRequest = this.isFlagEnabled("disableNoneLayerRequest"), u2.isVBEnabled = this.isFlagEnabled("vb"), u2.isHipaaEnabled = this.isFlagEnabled("hipaa"), u2.isNoiseCancellationEnabled = this.isFlagEnabled("noiseCancellation")), this.analyticsTimer.end("init_response_time"), He.setWebsocketEndpoint(this.initConfig.endpoint), this.validateNotDisconnected("post init"), yield this.openSignal(e, i2), this.observer.onConnected(), (d2 = this.connectivityListener) == null || d2.onSignallingSuccess(), this.store.setSimulcastEnabled(this.isFlagEnabled("simulcast")), l2.d(R2, "Adding Analytics Transport: JsonRpcSignal"), this.analyticsEventsService.setTransport(this.analyticsSignalTransport), this.analyticsEventsService.flush(), this.initConfig;
        } catch (u2) {
          throw this.state !== "Reconnecting" && this.eventBus.analytics.publish(y2.connect(u2, this.getAdditionalAnalyticsProperties(), s2, /* @__PURE__ */ new Date(), t2)), l2.e(R2, "\u274C internal connect: failed", u2), u2;
        }
      });
    }
    validateNotDisconnected(e) {
      if (this.state === "Disconnected") throw l2.w(R2, "aborting join as transport state is disconnected"), S2.GenericErrors.ValidationFailed(`leave called before join could complete - stage=${e}`);
    }
    openSignal(e, t2) {
      return c2(this, null, function* () {
        if (!this.initConfig) throw S2.APIErrors.InitConfigNotAvailable("INIT", "Init Config not found");
        l2.d(R2, "\u23F3 internal connect: connecting to ws endpoint", this.initConfig.endpoint);
        let i2 = new URL(this.initConfig.endpoint);
        i2.searchParams.set("peer", t2), i2.searchParams.set("token", e), i2.searchParams.set("user_agent_v2", this.store.getUserAgent()), i2.searchParams.set("protocol_version", pa), i2.searchParams.set("protocol_spec", ha), this.endpoint = i2.toString(), this.analyticsTimer.start("ws_connect_time"), yield this.signal.open(this.endpoint), this.analyticsTimer.end("ws_connect_time"), this.analyticsTimer.start("on_policy_change_time"), this.analyticsTimer.start("room_state_time"), l2.d(R2, "\u2705 internal connect: connected to ws endpoint");
      });
    }
    initStatsAnalytics() {
      var e, t2;
      this.isFlagEnabled("publishStats") && (this.publishStatsAnalytics = new Zt(this.store, this.eventBus, this.getValueFromInitConfig("publishStats", "maxSampleWindowSize", 30), this.getValueFromInitConfig("publishStats", "maxSamplePushInterval", 300)), (e = this.getWebrtcInternals()) == null || e.start()), this.isFlagEnabled("subscribeStats") && (this.subscribeStatsAnalytics = new ei(this.store, this.eventBus, this.getValueFromInitConfig("subscribeStats", "maxSampleWindowSize", 10), this.getValueFromInitConfig("subscribeStats", "maxSamplePushInterval", 60)), (t2 = this.getWebrtcInternals()) == null || t2.start());
    }
    ...
    getAdditionalAnalyticsProperties() {
      ...
      let e = go(), t2 = typeof document != "undefined" && document.hidden, i2 = this.store.getRemoteVideoTracks().filter((f2) => f2.degraded).length, r2 = (u2 = (d2 = (n2 = (o2 = this.getWebrtcInternals()) == null ? void 0 : o2.getCurrentStats()) == null ? void 0 : n2.getLocalPeerStats()) == null ? void 0 : d2.publish) == null ? void 0 : u2.bitrate, s2 = (g2 = (T = (h2 = (p2 = this.getWebrtcInternals()) == null ? void 0 : p2.getCurrentStats()) == null ? void 0 : h2.getLocalPeerStats()) == null ? void 0 : T.subscribe) == null ? void 0 : g2.bitrate;
  ...
  var fo = { published: false, isInitialised: false, isReconnecting: false, isPreviewInProgress: false, isPreviewCalled: false, isJoinInProgress: false, deviceManagersInitialised: false };
  var Ir = class {
    constructor() {
      this.TAG = "[HMSSdk]:";
      this.transportState = "Disconnected";
      this.analyticsTimer = new gi();
      this.sdkState = m({}, fo);
      this.isDiagnostics = false;
      this.playlistSettings = { video: { bitrate: Yr }, audio: { bitrate: Xr } };
    ...
    setSessionPeerInfo(e, t2) {
      ...
      this.sessionPeerInfo = { peer: { peer_id: t2.peerId, role: (r2 = t2.role) == null ? void 0 : r2.name, joined_at: ((s2 = t2.joinedAt) == null ? void 0 : s2.valueOf()) || 0, room_name: i2.name, session_started_at: ((o2 = i2.startedAt) == null ? void 0 : o2.valueOf()) || 0, user_data: t2.customerUserId, user_name: t2.name, template_id: i2.templateId, session_id: i2.sessionId, token: (n2 = this.store.getConfig()) == null ? void 0 : n2.authToken }, agent: this.store.getUserAgent(), device_id: hi(), cluster: { websocket_url: e }, timestamp: Date.now() };
    }
    initNotificationManager() {
      this.notificationManager || (this.notificationManager = new ur(this.store, this.eventBus, this.transport, this.listener, this.audioListener));
    }
    initStoreAndManagers(e) {
      ...
      this.sdkState.isInitialised = true, this.store = new Kt(), this.store.setErrorListener(this.errorListener), this.eventBus = new Jt(), this.pluginUsageTracker = new Ji(this.eventBus), this.wakeLockManager = new ji(), this.networkTestManager = new qi(this.eventBus, this.listener), this.playlistManager = new Nt(this, this.eventBus), this.deviceManager = new jt(this.store, this.eventBus), this.audioSinkManager = new qt(this.store, this.deviceManager, this.eventBus), this.audioOutput = new zi(this.deviceManager, this.audioSinkManager), this.audioSinkManager.setListener(this.listener), this.eventBus.autoplayError.subscribe(this.handleAutoplayError), this.localTrackManager = new Te(this.store, this.observer, this.deviceManager, this.eventBus, this.analyticsTimer), this.analyticsEventsService = new Qi(this.store), this.transport = new ni(this.observer, this.deviceManager, this.store, this.eventBus, this.analyticsEventsService, this.analyticsTimer, this.pluginUsageTracker), "onInitSuccess" in e && this.transport.setConnectivityListener(e), this.sessionStore = new pr(this.transport), this.interactivityCenter = new Yt(this.transport, this.store, this.listener), this.eventBus.analytics.subscribe(this.sendAnalyticsEvent), this.eventBus.deviceChange.subscribe(this.handleDeviceChange), this.eventBus.localVideoUnmutedNatively.subscribe(this.unpauseRemoteVideoTracks), this.eventBus.localAudioUnmutedNatively.subscribe(this.unpauseRemoteVideoTracks), this.eventBus.audioPluginFailed.subscribe(this.handleAudioPluginError), this.eventBus.error.subscribe(this.handleError);
    }
    validateJoined(e) {
    ...
    getDebugInfo() {
      ...
      let e = this.transport.getWebsocketEndpoint(), t2 = Object.values(hs).filter((s2) => this.transport.isFlagEnabled(s2)), i2 = (r2 = this.store.getConfig()) == null ? void 0 : r2.initEndpoint;
    ...
    getPeerListIterator(e) {
      return new Ii(this.transport, this.store, e);
    }
    ...
    preview(e, t2) {
      return c2(this, null, function* () {
        if (It(), bt(), this.sdkState.isPreviewInProgress) return Promise.reject(S2.GenericErrors.PreviewAlreadyInProgress("PREVIEW", "Preview already called"));
    ...
    join(e, t2) {
      return c2(this, null, function* () {
        var d2, u2, p2, h2, T, g2, f2, P2;
        if (It(), bt(), this.sdkState.isPreviewInProgress) throw S2.GenericErrors.NotReady("JOIN", "Preview is in progress, can't join");
        ...
        let { roomId: i2, userId: r2, role: s2 } = br(e.authToken), o2 = ((h2 = (p2 = this.localPeer) == null ? void 0 : p2.asRole) == null ? void 0 : h2.name) || ((g2 = (T = this.localPeer) == null ? void 0 : T.role) == null ? void 0 : g2.name);
        (f2 = this.networkTestManager) == null || f2.stop(), this.commonSetup(e, i2, t2), this.removeDevicesFromConfig(e), this.store.setConfig(e), this.store.createAndSetUserAgent(this.frameworkInfo), pe.resumeContext();
        let n2 = this.store.getConfig();
        n2 != null && n2.autoManageWakeLock && this.wakeLockManager.acquireLock(), this.localPeer ? (this.localPeer.name = e.userName, this.localPeer.role = this.store.getPolicyForRole(s2), this.localPeer.customerUserId = r2, this.localPeer.metadata = e.metaData, delete this.localPeer.asRole) : this.createAndAddLocalPeerToStore(e, s2, r2), this.roleChangeManager = new Wt(this.store, this.transport, this.deviceManager, this.getAndPublishTracks.bind(this), this.removeTrack.bind(this), this.listener), this.eventBus.localRoleUpdate.subscribe(this.handleLocalRoleUpdate), l2.d(this.TAG, `\u23F3 Joining room ${i2}`), l2.time(`join-room-${i2}`);
        try {
    ...
    cleanup() {
      var e, t2, i2;
      this.cleanDeviceManagers(), this.eventBus.analytics.unsubscribe(this.sendAnalyticsEvent), this.eventBus.localVideoUnmutedNatively.unsubscribe(this.unpauseRemoteVideoTracks), this.eventBus.localAudioUnmutedNatively.unsubscribe(this.unpauseRemoteVideoTracks), this.eventBus.error.unsubscribe(this.handleError), this.analyticsTimer.cleanup(), te.cleanup(), this.playlistManager.cleanup(), (e = this.wakeLockManager) == null || e.cleanup(), Te.cleanup(), this.notificationManager = void 0, l2.cleanup(), this.sdkState = m({}, fo), this.localPeer && ((t2 = this.localPeer.audioTrack) == null || t2.cleanup(), this.localPeer.audioTrack = void 0, (i2 = this.localPeer.videoTrack) == null || i2.cleanup(), this.localPeer.videoTrack = void 0), this.store.cleanup(), this.listener = void 0, this.roleChangeManager && this.eventBus.localRoleUpdate.unsubscribe(this.handleLocalRoleUpdate);
    }
    leave(e) {
    ...
    internalLeave(e = true, t2) {
      return c2(this, null, function* () {
        ...
        if (i2) {
          for (; (this.sdkState.isPreviewInProgress || this.sdkState.isJoinInProgress) && !(t2 != null && t2.isTerminal); ) yield Be(100);
          let d2 = i2.id;
    ...
    getAuthTokenByRoomCode(e, t2) {
      return c2(this, null, function* () {
        ...
        let r2 = yield Wi(i2, { method: "POST", body: JSON.stringify({ code: e.roomCode, user_id: e.userId }) }, [429, 500, 501, 502, 503, 504, 505, 506, 507, 508, 509, 510, 511]), s2 = yield r2.json();
    ...
    submitSessionFeedback(e, t2) {
      return c2(this, null, function* () {
        ...
        try {
          yield Qt.sendFeedback({ token: i2, info: this.sessionPeerInfo, feedback: e, eventEndpoint: t2 }), l2.i(this.TAG, "submitSessionFeedback> submitted feedback"), this.sessionPeerInfo = void 0;
        } catch (r2) {
    ...
    addTrack(e, t2 = "regular") {
      return c2(this, null, function* () {
        ...
        let r2 = e.kind, s2 = new MediaStream([e]), o2 = new fe(s2), n2 = r2 === "audio" ? he : K, d2 = new n2(o2, e, t2, this.eventBus);
    ...
    raiseLocalPeerHand() {
      return c2(this, null, function* () {
        var e;
        this.validateJoined("raiseLocalPeerHand"), yield (e = this.transport) == null ? void 0 : e.signal.joinGroup(Ie);
      });
    }
    lowerLocalPeerHand() {
      return c2(this, null, function* () {
        var e;
        this.validateJoined("lowerLocalPeerHand"), yield (e = this.transport) == null ? void 0 : e.signal.leaveGroup(Ie);
      });
    }
    raiseRemotePeerHand(e) {
      return c2(this, null, function* () {
        var t2;
        yield (t2 = this.transport) == null ? void 0 : t2.signal.addToGroup(e, Ie);
      });
    }
    lowerRemotePeerHand(e) {
      return c2(this, null, function* () {
        var t2;
        yield (t2 = this.transport) == null ? void 0 : t2.signal.removeFromGroup(e, Ie);
      });
    }
    setFrameworkInfo(e) {
    ...
    publish(e, t2) {
      return c2(this, null, function* () {
        var i2, r2, s2;
        if ([this.store.getPublishParams(), !this.sdkState.published, !$e].every((o2) => !!o2)) {
    ...
    initDeviceManagers() {
      return c2(this, null, function* () {
        var e, t2, i2, r2, s2;
        this.sdkState.deviceManagersInitialised || (this.sdkState.deviceManagersInitialised = true, yield this.deviceManager.init(), (yield this.deviceManager.updateOutputDevice((t2 = (e = this.store.getConfig()) == null ? void 0 : e.settings) == null ? void 0 : t2.audioOutputDeviceId)) || (yield this.deviceManager.updateOutputDevice((r2 = (i2 = te.getSelection()) == null ? void 0 : i2.audioOutput) == null ? void 0 : r2.deviceId)), this.audioSinkManager.init((s2 = this.store.getConfig()) == null ? void 0 : s2.audioSinkElementId));
      });
    }
    cleanDeviceManagers() {
    ...
    setUpPreview(e, t2) {
      ...
      let { roomId: i2, userId: r2, role: s2 } = br(e.authToken);
    ...
    setPlaylistSettings(r2) {
      return c2(this, arguments, function* ({ track: e, hmsTrack: t2, source: i2 }) {
        ...
        if (i2 === "videoplaylist") {
          let n2 = {};
          if (e.kind === "audio") n2.maxBitrate = ((s2 = this.playlistSettings.audio) == null ? void 0 : s2.bitrate) || Xr;
          else {
            n2.maxBitrate = ((o2 = this.playlistSettings.video) == null ? void 0 : o2.bitrate) || Yr;
    ...
    commonSetup(e, t2, i2) {
      this.stringifyMetadata(e), e.initEndpoint || (e.initEndpoint = "https://prod-init.100ms.live"), this.initStoreAndManagers(i2), this.store.getRoom() || this.store.setRoom(new ze(t2));
    }
      ...
      return c2(this, null, function* () {
        ...
        if (t2) {
          if (e instanceof K) {
            ...
            let r2 = t2[i2];
            if (!r2) return;
            let s2 = new J().codec(r2.codec).maxBitrate(r2.bitRate).maxFramerate(r2.frameRate).setWidth(r2.width).setHeight(r2.height).build();
            yield e.setSettings(s2);
          } else if (e instanceof he) {
            if (!t2.allowed.includes("audio")) return;
            let i2 = new Y2().codec(t2.audio.codec).maxBitrate(t2.audio.bitRate).build();
  ...
  var gt = class a9 {
    constructor(e, t2, i2) {
      this.getStats = () => (this.stats || (this.stats = new ci(this.store, this.sdk)), this.stats);
      this.getDiagnosticsSDK = () => (this.diagnostics || (this.diagnostics = this.actions.initDiagnostics()), this.diagnostics);
      e ? this.store = e : this.store = a9.createNewHMSStore(Ki("HMSStore"), li), i2 ? this.notifications = i2 : this.notifications = new Ni(this.store), t2 ? this.actions = t2 : (this.sdk = new Ir(), this.actions = new $i(this.store, this.sdk, this.notifications)), this.actions.setFrameworkInfo({ type: "js", sdkVersion: _r().version }), this.initialTriggerOnSubscribe = false, B2 && (window.__hms = this);
    }
    triggerOnSubscribe() {
  ...
  var Mo = (a10, e, t2) => {
    let i2;
    t2.getState(ce) === "Connected" && (i2 = vo(a10, e, t2)), t2.subscribe((r2) => {
      ["Connected", "Reconnecting"].includes(r2) ? i2 || (i2 = vo(a10, e, t2)) : ["Disconnected", "Failed"].includes(r2) && i2 && (sc(e, r2), i2(), i2 = void 0);
    }, ce);
  };
  var vo = (a10, e, t2) => {
    var s2, o2;
    ...
    let r2 = (o2 = a10.getWebrtcInternals()) == null ? void 0 : o2.onStatsChange((n2) => rc(e, n2, t2, a10));
    return () => {
      i2(), r2 && r2();
    };
  };
  var ic = (a10, e) => {
    let t2, i2, r2;
    return a10.getState(Ae) ? e.namedSetState((s2) => {
      s2.localPeer.id = a10.getState(Ae);
    }, "localpeer-id") : t2 = a10.subscribe((s2) => {
      s2 && e.namedSetState((o2) => {
        o2.localPeer.id = s2;
      }, "localpeer-id");
    }, Ae), a10.getState(ie) ? e.namedSetState((s2) => {
      s2.localPeer.videoTrack = a10.getState(ie);
    }, "localpeer-videotrack-id") : i2 = a10.subscribe((s2) => {
      s2 && e.namedSetState((o2) => {
        o2.localPeer.videoTrack = s2;
      }, "localpeer-videotrack-id");
    }, ie), a10.getState(me) ? e.namedSetState((s2) => {
      s2.localPeer.audioTrack = a10.getState(me);
  ...
  var rc = (a10, e, t2, i2) => {
    ...
    a10.namedSetState((s2) => {
      let o2 = t2.getState(Ae), n2 = {}, d2 = Object.keys(r2).filter((p2) => r2[p2].peerId !== o2);
      for (let p2 of d2) {
        let h2 = e.getRemoteTrackStats(p2);
        h2 && (n2[p2] = h2);
      }
      ds(s2.remoteTrackStats, n2);
      let u2 = { [o2]: e.getLocalPeerStats() };
      ds(s2.peerStats, u2), ro(s2.localTrackStats, e.getLocalTrackStats(), i2.store.getLocalPeerTracks());
    }, "webrtc-stats");
  };
  var sc = (a10, e = "resetState") => {
  ...
  var ci = class {
    constructor(e, t2) {
      this.hmsStore = e;
      this.sdk = t2;
      this.store = gt.createNewHMSStore(Ki("HMSStatsStore"), ui), this.getState = this.store.getState, this.subscribe = this.store.subscribe, this.getPublishPeerConnection = () => new Promise((i2) => {
        var r2, s2;
        this.hmsStore.getState(ce) === "Connected" ? i2((s2 = (r2 = this.sdk) == null ? void 0 : r2.getWebrtcInternals()) == null ? void 0 : s2.getPublishPeerConnection()) : this.hmsStore.subscribe((o2) => {
          var n2, d2;
        ...
        var r2, s2;
        this.hmsStore.getState(ce) === "Connected" ? i2((s2 = (r2 = this.sdk) == null ? void 0 : r2.getWebrtcInternals()) == null ? void 0 : s2.getSubscribePeerConnection()) : this.hmsStore.subscribe((o2) => {
          var n2, d2;
          o2 === "Connected" && i2((d2 = (n2 = this.sdk) == null ? void 0 : n2.getWebrtcInternals()) == null ? void 0 : d2.getSubscribePeerConnection());
        }, ce);
      }), this.sdk && Mo(this.sdk, this.store, this.hmsStore);
    }
  };
  var ac = (a10) => a10.localPeer.id;
  var oc = (a10) => a10.localPeer.audioTrack;
  var nc = (a10) => a10.localPeer.videoTrack;
  var cc = (a10, e) => e;
  var yo = (a10, e) => e;
  var dc = (a10) => a10.remoteTrackStats;
  var ko = (a10) => a10.peerStats;
  var Ts = (a10) => a10.localTrackStats;
  var Le = createSelector([ko, ac], (a10, e) => a10[e]);
  var lc = createSelector(Le, (a10) => {
    var e;
    return (e = a10 == null ? void 0 : a10.subscribe) == null ? void 0 : e.packetsLost;
  });
  var uc = createSelector(Le, (a10) => {
    var e;
    return (e = a10 == null ? void 0 : a10.subscribe) == null ? void 0 : e.jitter;
  });
  var pc = createSelector(Le, (a10) => {
    var e;
    return (e = a10 == null ? void 0 : a10.publish) == null ? void 0 : e.bitrate;
  });
  var hc = createSelector(Le, (a10) => {
    var e;
    return (e = a10 == null ? void 0 : a10.subscribe) == null ? void 0 : e.bitrate;
  });
  var mc = createSelector(Le, (a10) => {
    var e;
    return (e = a10 == null ? void 0 : a10.publish) == null ? void 0 : e.availableOutgoingBitrate;
  });
  var Sc = createSelector(Le, (a10) => {
    var e;
    return (e = a10 == null ? void 0 : a10.subscribe) == null ? void 0 : e.availableIncomingBitrate;
  });
  var gc = createSelector(Le, (a10) => {
    var e;
    return (e = a10 == null ? void 0 : a10.publish) == null ? void 0 : e.bytesSent;
  });
  var Tc = createSelector(Le, (a10) => {
    var e;
    return (e = a10 == null ? void 0 : a10.subscribe) == null ? void 0 : e.bytesReceived;
  });
  var fc = createSelector([ko, cc], (a10, e) => e ? a10[e] : void 0);
  var vc = createSelector([dc, yo], (a10, e) => e ? a10[e] : void 0);
  var fs = createSelector([Ts, yo], (a10, e) => e ? a10[e] : void 0);
  var Mc = H2(fc);
  var yc = H2(vc);
  var kc = createSelector([Ts, oc], (a10, e) => {
    var t2;
    return e ? (t2 = a10[e]) == null ? void 0 : t2[0] : void 0;
  });
  var Ec = H2(createSelector(fs, (a10) => a10 == null ? void 0 : a10[0]));
  var Pc = createSelector([Ts, nc], (a10, e) => {
    var t2;
    return e ? (t2 = a10[e]) == null ? void 0 : t2[0] : void 0;
  });
  var bc = H2(createSelector(fs, (a10) => a10));

  // _hms-entry.js
  window.HMSReactiveStore = gt;
  window._hms100msReady = true;
})();
