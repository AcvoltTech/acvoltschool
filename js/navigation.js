    ...
    var SCREEN_SCRIPTS = {
      ...
      acvoltCertScreen: ['js/acvolt-certification.js', 'js/acvolt-quiz-leccion.js'],
      acvoltCourseScreen: ['js/acvolt-certification.js', 'js/acvolt-quiz-leccion.js'],
      acvoltLessonScreen: ['js/acvolt-certification.js', 'js/acvolt-quiz-leccion.js'],
...
function showScreen(screenId) {
    ...
    if ((window.isIOSAppStore || window.isAndroidPlayStore) && (screenId === 'membresiasScreen' || screenId === 'referidosScreen' || screenId === 'misPagosScreen')) {
      ...
      // REVERTIDO 2026-06-26: el candado de escuela en las zonas de estudio bloqueaba a los
      // estudiantes con token (no pagan Stripe) → quedaron sin acceso. Quitado. Las zonas de
      // estudio en la web vuelven a estar abiertas como antes.
